...
<tr>
<td style="text-align:left">Enterprise Edition</td>
<td style="text-align:left">The support user feature has been extended. It is now possible to deactivate the support user and to see support access status in the subtenants details. For more information, see the <a href="/users-guide/enterprise-tenant/#users-in-other-tenants"> Enterprise Tenant > Support user access</a> documentation.</td>
</tr>
<tr>
...
<td style="text-align:left">Support for pre-defined topics has been added. For more information, see the <a href="/device-sdk/mqtt/#mqtt-static-templates">MQTT Static templates documentation.</a></td>
</tr>
<tr>
<td style="text-align:left">MQTT</td>
