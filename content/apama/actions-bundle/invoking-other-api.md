...
For more information, see [REST implementation](https://www.{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#section/REST-implementation) in the Cumulocity IoT OpenAPI Specification
