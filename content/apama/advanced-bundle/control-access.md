...
(also see the [Tenant API](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#tag/Tenant-API) in the Cumulocity IoT OpenAPI Specification) or use a curl command as given in the example below:
