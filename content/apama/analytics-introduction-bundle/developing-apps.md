...
Once the EPL application is ready, refer to [Deploying applications](/apama/analytics-introduction/#deploying-apps) to find out how to deploy it to Cumulocity IoT.
