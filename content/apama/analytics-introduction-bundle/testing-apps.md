...
Apama EPL Apps Tools is available from [https://github.com/SoftwareAG/apama-eplapps-tools](https://github.com/SoftwareAG/apama-eplapps-tools). See the documentation in GitHub for detailed information.
