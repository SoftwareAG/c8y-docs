...
<div style="padding: 24px ; border: 2px solid #1776BF; border-radius: 4px; margin-bottom: 24px; background-color: #f6fafe ">
  ...
  <p class="lead" style="font-size:22px"> The release notes for {{< product-name-1 >}} Streaming Analytics have been moved to a new <a href="https://{{< URL >}}/guides/releasenotes/about">release notes page</a>:</p>
...
You can access the release notes page from a link in the top navigation on the documentation website or using the URL <a href="https://{{< URL >}}/guides/releasenotes/about">https://{{< URL >}}/guides/releasenotes/about</a>.
