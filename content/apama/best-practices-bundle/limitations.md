...
* Apama-epl - the simplest mechanism to deploy Apama assets into a fully managed Apama correlator, see [Basic functionality > Deploying applications](/guides/apama/analytics-introduction/#deploying-apps).
