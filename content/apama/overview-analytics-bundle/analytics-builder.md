...
layout: redirect
---
The **Analytics Builder** page of the Streaming Analytics web app allows you to build analytic models that transform or analyze streaming data in order to generate new data or output events. The models are capable of processing data in real time.
