...
- Alarms on the Apama license key.
...
This alarm is raised when correlator cannot find a valid Apama license.
...
<!--For more information on available diagnostic tools, refer to "Diagnostic tools for Apama in Cumulocity". KOL: I cannot yet put this into the public doc. We need to wait until this information is also publicly available somewhere.-->
