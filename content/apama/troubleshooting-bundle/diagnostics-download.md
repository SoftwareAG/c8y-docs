...
- The microservice log file contents, if available, including a record of the correlator's startup logging and the last hour or maximum of 20,000 lines of logging.
    ...
    > **Info:** In case of {{< product-c8y-iot >}} Edge, since Apama-ctrl is not deployed as a microservice in Edge, 
      ...
      and [Diagnostics](/edge/diagnostics-and-support/#diagnostics) both in the *{{< product-c8y-iot >}} Edge guide*.
