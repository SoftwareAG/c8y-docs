...
- [Sigfox](/devie-protocols-guide/sigfox)
...
Je nach gewähltem Anbieter können zusätzliche Felder vorhanden sein, die in der Dokumentation des entsprechenden Agents erläutert werden, siehe [Device protocol guide](/device-protocols-guide/overview/).
