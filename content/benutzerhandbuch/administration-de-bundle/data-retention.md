...
<img src="/images/benutzerhandbuch/Administration/admin-retention-rules.png" alt="Datenhaltungsregeln">
...
|---------------|-------------------|-----------------|------------|---------------------|
| MEASUREMENT   | *                 | c8y_Temperature | *          | 30 Tage             |
| MEASUREMENT   | *                 | c8y_Temperature | 12345      | 60 Tage             |
...
<img src="/images/benutzerhandbuch/Administration/admin-files-repository.png" alt="Dateiablage" style="max-width: 100%">
