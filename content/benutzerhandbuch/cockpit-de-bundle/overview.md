...
|[Verwalten von Berichten](/benutzerhandbuch/cockpit-de/#reports)|Bearbeiten Sie [Berichte](#reports) auf Basis von Dashboard-Layouts, erstellen Sie [Berichte zum Exportieren von Daten](#export) in das CSV- oder Excel-Format und [terminieren Sie den Export](#schedule-export). 
