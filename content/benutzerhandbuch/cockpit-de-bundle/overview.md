...
|[Verwalten von Berichten und Exportdaten](#reports)|Bearbeiten Sie [Berichte](#reports) auf Basis von Dashboard-Layouts, erstellen Sie [Berichte zum Exportieren von Daten](#reporting) in das CSV- oder Excel-Format und [terminieren Sie den Export](#schedule-export). 
