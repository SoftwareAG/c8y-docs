...
|[Verwenden von Alarmen](/users-guide/device-management/#alarm-monitoring)|Überwachen Sie Probleme Ihrer Geräte mit Hilfe von Schweregraden und Prozessen. Da die Verwendung von Alarmen in der Cockpit-Anwendung exakt so funktioniert wie in der Device Management-Anwendung finden Sie weitere Informationen in [Verwenden von Alarmen](/users-guide/device-management/#alarm-monitoring) unter Device Management. 
|[Verwalten von Berichten und Exporten](#reports)|Bearbeiten Sie [Berichte](#reports) auf Basis von Dashboard-Layouts, erstellen Sie [Berichte zum Exportieren von Daten](#reporting) in das CSV- oder Excel-Format und [terminieren Sie den Export](#schedule-export). 
...
Mehr über allgemeine Aspekte der Cumulocity-Plattform und ihrer Anwendungen erfahren Sie unter [Erste Schritte](/users-guide/overview).
