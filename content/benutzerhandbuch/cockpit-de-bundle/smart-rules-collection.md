...
* Prüfen Sie, ob sich das Gerät im [Wartungsmodus](/benutzerhandbuch/device-management-de#connection-monitoring) befindet. In diesem Fall wird das Erzeugen eines Alarms unterdrückt.
