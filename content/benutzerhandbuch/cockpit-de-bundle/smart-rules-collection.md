...
* Prüfen Sie, ob sich das Gerät im [Wartungsmodus](/reference/device-management/#device-availability) befindet. In diesem Fall wird das Erzeugen eines Alarms unterdrückt.
