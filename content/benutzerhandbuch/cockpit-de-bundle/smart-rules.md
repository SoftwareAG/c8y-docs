...
Cumulocity enthält eine Regel-Engine, um Daten in Echtzeit zu analysieren und Aktionen basierend auf Daten auszuführen. Diese Regeln werden in einer Skriptsprache erstellt und in der ["Administration"-Anwendung](/guides/benutzerhandbuch/administration) verwaltet.
...
![Smart Rules info tab](/guides/images/benutzerhandbuch/cockpit/cockpit-smart-rules-info-tab.png)

* auf der Seite **Smart Rules** im Menü **Konfiguration**. <br><br>
![Smart Rules info tab](/guides/images/benutzerhandbuch/cockpit/cockpit-smart-rules-list.png)
...
Auf der Seite **Smart Rules** werden nur die globalen Smart Rules angezeigt. In einem lokalen Kontext (Gruppe oder Gerät) und ohne entsprechende Berechtigungen werden nur die lokalen Smart Rules angezeigt. Hat ein Benutzer die entsprechenden Berechtigungen, werden lokale und globale Smart Rules angezeigt.		
...
2. Wählen Sie eine Smart Rule-Template aus. Die Liste der Smart Rules kann je nach Installation variieren.
...
<img src="/guides/images/benutzerhandbuch/cockpit/cockpit-smart-rules-enable.png" name="Smart rule in Info tab" />
...
4. Öffnen Sie über das Menüsymbol das Kontextmenü für den entsprechenden Datenpunkt und klicken Sie **Smart Rule erstellen**. <br><br> <img src="/guides/images/benutzerhandbuch/cockpit/cockpit-smart-rules-data-point.png" name="Datenpunkt-Beispiel"/>
<br>
