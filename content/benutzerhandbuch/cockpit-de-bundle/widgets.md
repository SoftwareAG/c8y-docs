...
![Recent alarms widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-recent-alarms.png)

Nähere Informationen zu Alarmen finden Sie unter [Device Management > Verwenden von Alarmen](/guides/benutzerhandbuch/device-management/#alarm-monitoring).


### Alarmliste

Das Widget "Alarmliste" zeigt eine Liste von Alarmen, gefiltert nach Objekten, Alarmschweregrad und Alarmstatus. Nähere Informationen zu den einzelnen Alarmen finden Sie unter [Device Management > Verwenden von Alarmen](/guides/benutzerhandbuch/device-management/#alarm-monitoring).

![Alarm list widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-alarm-list.png)
...
![Critical alarms](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-critical-alarms.png)

Nähere Informationen zu den einzelnen Alarmen finden Sie unter [Device Management > Verwenden von Alarmen](/guides/benutzerhandbuch/device-management/#alarm-monitoring).
...
![Applications widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-applications.png)
...
![Asset notes widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-asset-notes.png)
...
![Asset properties widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-asset-properties.png)
...
![Asset table widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-asset-table.png)

Die daraus resultierende Tabelle wird folgendermaßen visualisiert:

![Asset table widget example](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-asset-table-example.png)
...
![Reboot device button configuration](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-asset-table-buttonconfig.png)

>**Info:** Der Dialog zeigt die vordefinierten Shell-Kommandos des ersten Geräts, das Shell-Kommandos unterstützt. Gibt es kein solches Gerät, ist die Liste leer. Weitere Informationen finden Sie unter [Device Management > Shell-Kommandos](/guides/benutzerhandbuch/device-management/#shell).<br>
...
<img src="/guides/images/benutzerhandbuch/cockpit/Cockpit_DataPointsGraphWidget.png" name="Data Point Graph widget" style="width:75%;"/>
...
![Data point table](/guides/images/benutzerhandbuch/cockpit/cockpit-datapointtable.png)

### Ereignisliste

Das Widget "Ereignisliste" ermöglicht es, Ereignisse für ein ausgewähltes Gerät zu überwachen. 

![Event list widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-event-list.png)
...
![Help and service widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-help-service.png)
...
![HTML widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-html.png)

### Infoanzeige

Das Widget "Infoanzeige" visualisiert einen Datenpunkt in Form eines Tachos und mehrere Datenpunkte als Beschriftung. 

![Info gauge widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-info-gauge.png)
...
![Info gauge widget data point gauge](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-data-gauge.png)

![Info gauge widget data point label](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-data-labels.png)
...
![Info gauge widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-linear-gauge.png)
...
![Info gauge widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-map.png)
...
![Quick links widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-quick-links.png)
...
Nähere Informationen zum Widget "SCADA" finden Sie unter [Optionale Services > Cloud Fieldbus > Monitoring status using the SCADA widget](/guides/users-guide/optional-services/#scada).

> **Info:** Alle SVG-Dateien werden bereinigt, um schädlichen Code zu entfernen.

![SCADA widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-scada.png)
...
![Radial gauge widget](/guides/images/benutzerhandbuch/cockpit/cockpit-widget-radial-gauge.png)
...
<img src="/guides/images/benutzerhandbuch/cockpit/Cockpit_TwitterNewsWidget.png" name="Twitter news widget" style="width:50%;"/>
