...
### <a name="dev-registration"></a> Registrieren von Geräten
...
* **Akzeptiert** - Der Benutzer hat erlaubt, dass die Zugangsdaten an das Gerät gesendet werden. Geräte können auf verschiedene Weise mit Ihrem Cumulocity-Konto verbunden werden.
...
**Info**: Im Falle von Problemen lesen Sie die Dokumentation zu Ihrem Gerätetyp im [Devices Guide](/devices) oder schlagen Sie im Handbuch zu Ihrem Gerät nach.
