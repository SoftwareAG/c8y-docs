...
[Bulk device credentials](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#operation/postBulkNewDeviceRequestCollectionResource) in der Cumulocity IoT OpenAPI Specification.
