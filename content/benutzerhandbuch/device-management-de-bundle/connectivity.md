...
* Das Gerät ist mit dem Netzwerk verbunden. Falls sich das Gerät nicht mit dem Netzwerk verbindet, kann dies mehrere Ursachen haben:
...
* Wenn das Gerät die Shell-Funktion unterstützt, navigieren zur [Registerkarte **Shell**](/users-guide/device-management/#shell). Überprüfen Sie die APN-Einstellungen und die Roaming-Konfiguration und bearbeiten Sie sie gegebenenfalls.
