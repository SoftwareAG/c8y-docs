...
Um Daten aus verschiedenen Gerätetypen zu verarbeiten, verwendet Cumulocity sogenannte Geräteprotokolle, die in einer Gerätedatenbank gespeichert sind.

Klicken Sie **Gerätedatenbank** im Menü **Gerätetypen** des Navigators.

Die **Gerätedatenbank**-Seite zeigt eine Liste aller in Ihrem Konto verfügbaren Geräteprotokolle an.
...
1. Klicken Sie **Geräteprotokoll hinzufügen** in der oberen Menüleiste. 
	...
	![Add device protocol](/images/benutzerhandbuch/DeviceManagement/devmgmt-device-protocol-add.png)
...
1. Klicken Sie **Importieren** in der oberen Menüleiste.
 <br><br>![Import device protocol](/images/benutzerhandbuch/DeviceManagement/devmgmt-device-protocol-import.png)
