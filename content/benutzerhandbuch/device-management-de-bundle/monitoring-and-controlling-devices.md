...
![Device map](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devices-map.png)
...
<img src="/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devices-connectionstatus.png" alt="Connection Status">
...
<img src="/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devices-deviceinfostatus.png" alt="Device Status">
...
<img src="/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devices-deviceinfomaintenance.png" alt="Device status maintenance">
...
Klicken Sie **Serviceüberwachung** im Menü **Geräte** im Navigator, um den Gesamtservice aller Geräte anzuzeigen.
 
![Service monitoring](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devices-servicemonitoring.png)
...
* Um die Alarme für alle Geräte zu überprüfen, klicken Sie **Alarme** im Menü **Übersichten** im Navigator. 
* Um die Alarme eines bestimmten Geräts zu überprüfen, wechseln Sie zur Registerkarte **Alarm** in den Details dieses Geräts.

![Alarms page](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-alarms.png)
...
* **Status**: Enthält weitere Informationen zum Alarmstatus und zeigt den Alarmtypen an. Die Typ-Information wird verwendet, um die Priorität von Alarmen zu konfigurieren, siehe [Administration > Priorisieren von Alarmen](/guides/benutzerhandbuch/administration/#reprio-alarms).
...
![Alarm change status](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-alarms-status.png)

Außerdem ist es möglich, den Status aller Alarme auf einmal auf "aufgehoben" zu setzen. Klicken Sie **Alle aufheben** in der oberen Menüleiste, um alle Alarme der gewählten Schweregrade aufzuheben.
...
![Device Control](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devicecontrol.png)
...
![Operation Details](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devicecontrol-history.png)
...
Kommandos für ein bestimmtes Gerät werden in der Registerkarte **Shell** des Geräts ausgeführt, siehe [Gerätedetails > Shell](/guides/benutzerhandbuch/device-management#shell).
...
![Execute bulk operations](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-devicecontrol-bulk.png)
...
![Bulk operations tab](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-bulkoperations.png)
...
![Edit bulk operations](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-bulkoperations-reschedule.png)
...
![Events](/guides/images/benutzerhandbuch/DeviceManagement/devmgmt-events.png)
