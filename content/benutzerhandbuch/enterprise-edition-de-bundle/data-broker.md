...
<td style="text-align:left">Die Gruppe oder das Gerät, die/das weitergeleitet wird. Wird hier eine Gruppe ausgewählt, werden alle Untergruppen und Untergeräte ebenfalls weitergeleitet. Wenn Sie die Standardoption „Alle Objekte“ ausgewählt lassen, werden alle Objekttypen einschließlich der internen und technischen Objekte synchronisiert (also nicht ausschließlich Gruppen und Geräte). Dies kann zu Problemen beim Zielmandanten führen.</td>
</tr>
<tr>
...
Weitere Informationen zu Alarmen finden Sie unter [Device Management > Überwachen und Steuern von Geräten > Verwenden von Alarmen](/users-guide/device-management/#alarm-monitoring).
