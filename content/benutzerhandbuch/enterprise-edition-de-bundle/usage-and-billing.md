...
|[TenantUsageStatistics](#usage-stats)|API-Anfragen|x| |
|[TenantUsageStatistics](#usage-stats)|API-Anfrage von Geräten|x| |
|[TenantUsageStatistics](#usage-stats)|Speicher|x|x|
|[TenantUsageStatistics](#usage-stats)|Höchstwert Speicher|x| |
|[TenantUsageStatistics](#usage-stats)|Hauptgerät|x| |
|[TenantUsageStatistics](#usage-stats)|Höchstwert Hauptgerät|x| |
|[TenantUsageStatistics](#usage-stats)|Geräte|x|x|
|[TenantUsageStatistics](#usage-stats)|Höchstwert Geräte|x| |
|[TenantUsageStatistics](#usage-stats)|Endpunktgeräte|x| |
|[TenantUsageStatistics](#usage-stats)|Abonnierte Anwendungen|x| |
|[TenantUsageStatistics](#usage-stats)|Erstellungszeitpunkt|x|x|
|[TenantUsageStatistics](#usage-stats)|Erzeugte Alarme|x| |
|[TenantUsageStatistics](#usage-stats)|Aktualisierte Alarme|x| |
|[TenantUsageStatistics](#usage-stats)|Erstellte Stammdaten|x| |
|[TenantUsageStatistics](#usage-stats)|Aktualisierte Stammdaten|x| |
|[TenantUsageStatistics](#usage-stats)|Erstellte Ereignisse|x| |
|[TenantUsageStatistics](#usage-stats)|Aktualisierte Ereignisse|x| |
|[TenantUsageStatistics](#usage-stats)|Erstellte Messwerte|x| |
|[TenantUsageStatistics](#usage-stats)|Gesamt Inbound-Transfer|x| |
|[TenantUsageStatistics](#usage-stats)|Übergeordneter Mandant|x|x|
|[TenantUsageStatistics](#usage-stats)|Mandanten-Domain| |x|
|[TenantUsageStatistics](#usage-stats)|Kann Untermandanten erstellen| |x|
|[TenantUsageStatistics](#usage-stats)|Externe Referenz|x|x|
|[TenantUsageStatistics](#usage-stats)|Microservice-CPU-Nutzung gesamt|x| |
|[TenantUsageStatistics](#usage-stats)|Microservice-Speichernutzung gesamt|x| |
|[MicroserviceUsageStatistics](#microservice-usage)|CPU-Nutzung pro Microservice| |x|
|[MicroserviceUsageStatistics](#microservice-usage)|Speichernutzung pro Microservice| |x|
|[DeviceStatistics](/reference/tenants/#device-statistics)|Monatliche Messwerte, Ereignisse und Alarme, pro Gerät erstellt und aktualisiert.| |x|