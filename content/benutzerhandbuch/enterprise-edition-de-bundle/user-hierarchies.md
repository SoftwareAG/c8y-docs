...
Eine kleine Zahl neben dem Benutzernamen zeigt an, wieviele direkt untergeordnete Benutzer ein Benutzer hat. Untergeordnete Benutzer sind Benutzer, die von ihrem übergeordneten Benutzer verwaltet werden können und die maximal die Berechtigungen des übergeordneten Benutzers haben können. Im Beispiel unten hat der Benutzer "Demo user" einen direkt untergeordneten Benutzer. 

![User hierarchies](/guides/images/benutzerhandbuch/enterprise-tenant/et-user-hierarchy.png)
...
![Select owner](/guides/images/benutzerhandbuch/enterprise-tenant/et-user-hierarchy-assign-owner.png) 

> **Info:** Wenn Sie einen neuen Benutzer erstellen, wird der Besitzer automatisch auf den Benutzer gesetzt, der angemeldet ist. Der Besitzer kann später geändert werden. Nur Benutzer mit der Berechtigung "Benutzer/Admin" können Besitzer zuweisen. 
...
Ein Benutzer A hat die Rolle "business". Der Benutzer A wird zum Besitzer eines neuen Benutzers B. Dann kann der neue Benutzer B nur die Rolle "business" erhalten (und zum Beispiel keine Admin-Rolle), da er keine höhere Berechtigung haben kann als sein Besitzer.

![Owner Sample](/guides/images/benutzerhandbuch/enterprise-tenant/et-user-hierarchy-roles.png)
...
![User delegation](/guides/images/benutzerhandbuch/enterprise-tenant/et-user-hierarchy-delegate.png)
...
![Warning message](/guides/images/benutzerhandbuch/enterprise-tenant/et-warning.png)