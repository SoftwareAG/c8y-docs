...
Wenn Sie sich das erste Mal bei der Cumulocity IoT-Plattform anmelden, werden Sie zur Standardanwendung (falls nicht anders konfiguriert, ist dies die [Cockpit](/users-guide/cockpit)-Anwendung) weitergeleitet.
