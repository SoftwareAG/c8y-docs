...
Eine ausführliche Liste aller mit {{< product-c8y-iot >}} verfügbaren Anwendungen finden Sie unter [Administration > Verwalten von Anwendungen](/users-guide/administration/#managing-applications).

Darüber hinaus bietet die {{< product-c8y-iot >}}-Plattform vielfältige Funktionalitäten zur Nutzung Ihrer eigenen Anwendungen über Ihr {{< product-c8y-iot >}}-Konto, siehe Details unter [Administration > Verwalten von Anwendungen](/users-guide/administration#managing-applications).
