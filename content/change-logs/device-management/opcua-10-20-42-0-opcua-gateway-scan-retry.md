...
A new OPC UA device gateway property has been added that allows to configure the pause length between retries (`gateway.scanAddressSpace.pauseMillisForRetry`) during the address space scan.