...
version: 1019.22.1
---
Administrators can no longer change the global roles and inventory roles of users managed by the single sign-on (SSO) server if they are updated during each login. The option "
