...
- In the **Smart rules** tab of a device or group.
  ...
  From the context of a group or device, or in the **Status** tab of the owned microservice it is possible to modify only local smart rule. Editing global smart rules is only possible on the **Global smart rules** page. 
