...
{{< product-c8y-iot >}} also offers the optional [DataHub](datahub/datahub-overview/) application that is geared towards data analysts and data scientists and allows for offloading of IoT data to a data lake storage as well as to perform complex SQL queries on the data to derive deeper insights.
