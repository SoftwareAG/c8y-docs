...
More information can be found in [Identity](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#tag/Identity-API) in the Cumulocity IoT OpenAPI Specification.
...
More detailed information for working with the inventory can be found in [Inventory](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#tag/Inventory-API) in the Cumulocity IoT OpenAPI Specification.
