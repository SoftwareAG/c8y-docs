...
2. When designing assets hierarchy, be advised to use smaller groups limiting it to 1000 subassets. Each subitem in assets hierarchy creates a reference record in parent item. Therefor keep in mind 1st recommendation regarding JSON document size.
