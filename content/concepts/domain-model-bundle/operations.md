...
More details can be found in [Device control](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#tag/Device-control-API) in the Cumulocity IoT OpenAPI Specification.
