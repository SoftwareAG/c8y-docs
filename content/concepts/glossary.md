...
For devices that are natively connected to the {{< product-c8y-iot >}} platform (for example, using device SDKs, thin-edge.io or REST/MQTT interfaces), you don't need to create device protocols.
