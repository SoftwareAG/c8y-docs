...
{{< c8y-admon-info >}}
For details on release types (GA release, Maintenance release) and their version labels see [Release types](https://cumulocity.com/releasenotes/about/release-types/).
{{< /c8y-admon-info >}}
