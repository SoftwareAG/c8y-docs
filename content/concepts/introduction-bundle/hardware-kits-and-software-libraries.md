...
Detailed information on device integration using [MQTT](/device-sdk/mqtt), [REST](/device-sdk/rest), [C++](/device-sdk/cpp) and [C#](/device-sdk/hello-mqtt-cs-0) can be found in the [Device SDK guide](/device-sdk/device-sdk-introduction).
