...
Detailed information on device integration using [MQTT](/device-integration/mqtt/) and [REST](/device-integration/device-integration-rest/) can be found in [Device integration](/device-integration/introduction/).
