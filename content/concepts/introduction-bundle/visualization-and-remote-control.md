...
Through the [Sensor library](https://{{< domain-c8y >}}/api/#section/Sensor-library), common sensor and control types are rendered  correctly regardless of the device that produces the sensor data.
