...
> **Info:** DataHub only supports offloading for the following base {{< product-c8y-iot >}} collections: **alarms**, **events**, **inventory**, **measurements**. Offloading of other collections is currently not supported.
