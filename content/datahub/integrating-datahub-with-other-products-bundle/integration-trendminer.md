...
For more details on the steps required in TrendMiner, see also the [TrendMiner documentation](https://documentation.trendminer.com/en/63081-connector-configuration.html).
