...
* The {{< product-c8y-iot >}} DataHub UI is deployed as a web app in the {{< product-c8y-iot >}} core. It provides the frontend for defining and managing offloading pipelines.
