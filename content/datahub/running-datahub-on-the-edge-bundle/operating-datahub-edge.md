...
If you still need to contact [product support](/welcome/contacting-support), include the output of the diagnostics script. See the section on [Diagnostics and support > Diagnostics](/edge/diagnostics-and-support/#diagnostics) in the *{{< product-c8y-iot >}} Edge guide* for details of how to run it.
