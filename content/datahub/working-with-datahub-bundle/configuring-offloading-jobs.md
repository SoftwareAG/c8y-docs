...
The **Offloading task name** is an identifier for the offloading pipeline. Even though it does not have to be unique, it is advisable to use an unique identifier for this task name.
...
### Offloading of alarms collection
...
### Offloading of events collection
...
### Offloading of inventory collection
...
### Offloading of measurements collection
...
| | |
| ---- | ----- |
| c8y_Temperature.T.value | c8y_Temperature.T.unit |
| 2.0791169082 | C | 
