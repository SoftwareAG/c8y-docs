...
-   [Device integration > Fragment library](/device-integration/fragment-library/) specifies managed objects (devices) as well as for predefined sensor and control capabilities of devices.
