...
* When you take a new device into use, you enter this unique ID into **Device registration** in the **Device Management** web app in {{< product-c8y-iot >}}, and start the device.
