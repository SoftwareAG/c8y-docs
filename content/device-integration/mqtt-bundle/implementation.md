...
The two-way SSL support is enabled by default. To disable it contact [product support](/additional-resources/contacting-support/).
...
* In order to support this situation, the platform needs to be configured accordingly. In case you experience issues contact [product support](/additional-resources/contacting-support/).
