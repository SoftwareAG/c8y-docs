...
3. Follow the steps described in [Monitoring and controlling devices > Working with operations > To add a bulk operation](/device-management-application/#bulk-operations) to schedule a bulk operation which applies a device profile.
