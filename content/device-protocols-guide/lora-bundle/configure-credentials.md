...
![Setting provider credentials](/images/device-protocols-guide/lora-actility/lora-admin-settings.png)
...
![Replace credentials](/images/device-protocols-guide/lora-actility/lora-admin-settings-replace.png)
