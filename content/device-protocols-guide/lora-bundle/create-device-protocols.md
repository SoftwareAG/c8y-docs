...
![Import device protocol](/images/device-protocols-guide/lora-actility/lora-protocols-import.png)
...
![Create new LoRa protocol](/images/device-protocols-guide/lora-actility/lora-protocols-new.png)
...
<img src="/images/device-protocols-guide/lora-actility/lora-payload-example1.png" alt="Example payload: message type source" style="max-width: 100%">
...
![LoRa protocol payload](/images/device-protocols-guide/lora-actility/lora-protocols-payload.png)

Click **Add value** to create the value configuration.

![LoRa protocol add value](/images/device-protocols-guide/lora-actility/lora-protocols-addvalue.png)

In the upcoming window, configure the relevant values as shown in this example.

**New value window part 1**
![LoRa protocol add new value](/images/device-protocols-guide/lora-actility/lora-protocols-newvalue.png)

**New value window part 2**
![LoRa protocol add new value](/images/device-protocols-guide/lora-actility/lora-protocols-newvalue2.png)
...
<img src="/images/device-protocols-guide/lora-actility/lora-payload-example2.png" alt="Example payload: message type source" style="max-width: 100%">

![LoRa bits](/images/device-protocols-guide/lora-actility/lora-protocols-loraid.png)
...
<img src="/images/device-protocols-guide/lora-actility/lora-payload-example3.png" alt="Example payload: value selection" style="max-width: 100%">

![LoRa bits](/images/device-protocols-guide/lora-actility/lora-protocols-lorabits.png)
...
![Value configurations of created device protocol](/images/device-protocols-guide/lora-actility/lora-protocols-loraprotocol.png)
...
![Value configuration in detail: nested structure](/images/device-protocols-guide/lora-actility/lora-protocols-gpsexample.png)
