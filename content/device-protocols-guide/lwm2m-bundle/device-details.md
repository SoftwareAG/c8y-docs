...
![Objects view](/images/device-protocols-guide/lwm2m/lwm2m-objects.png)
...
<br><br>
![Read Objects](/images/device-protocols-guide/lwm2m/lwm2m-devices-readobject.png)
<br><br>
- Read Instance: Reads the current instance of the given object and lists all available resources.
<br><br>
![Read Instance](/images/device-protocols-guide/lwm2m/lwm2m-devices-readinstance.png)
<br><br>
...
![Execute operation](/images/device-protocols-guide/lwm2m/lwm2m-devices-execute.png)

More information can be acquired for each resource by hovering over the tooltip icon.

![Tooltip](/images/device-protocols-guide/lwm2m/lwm2m-devices-tooltip.png)
...
![Recent operations](/images/device-protocols-guide/lwm2m/lwm2m-devices-operations.png)
![Recent operations 2](/images/device-protocols-guide/lwm2m/lwm2m-devices-operations2.png)
...
![Audit configuration](/images/device-protocols-guide/lwm2m/lwm2m-devices-audit.png)
...
![Sync properties](/images/device-protocols-guide/lwm2m/lwm2m-devices-sync.png)
...
![Bootstrap customization](/images/device-protocols-guide/lwm2m/lwm2m-devices-bootstrap.png)
