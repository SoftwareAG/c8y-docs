...
![CSV example 1](/images/device-protocols-guide/lwm2m/lwm2m-csv1.png)
...
![CSV example 2.1](/images/device-protocols-guide/lwm2m/lwm2m-psk-example.png)
...
![Alarm for duplicated device with endpoint](/images/device-protocols-guide/lwm2m/lwm2m-alarm-for-duplicated-device-with-endpoint.png)
