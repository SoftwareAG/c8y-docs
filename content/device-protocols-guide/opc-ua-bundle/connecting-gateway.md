...
1. In the **OPC UA server** tab of the respective gateway, click **Add server**. <br>
   ![Add new server](/images/device-protocols-guide/opcua/opcua-new-server.png)
...
7. Select the desired authentication method. For more info, see [Authentication](/device-protocols-guide/opc-ua/#authentication).
8. Click **Save**.
