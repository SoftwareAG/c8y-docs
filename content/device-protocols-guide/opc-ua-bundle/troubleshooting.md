...
![Permission denied](/images/device-protocols-guide/opcua/opcua-permission-denied-error.png)
...
![Failed to load](/images/device-protocols-guide/opcua/opcua-failed-to-load.png)

### java.net.BindException: Address already in use

![Address in use](/images/device-protocols-guide/opcua/opcua-address-in-use.png)
