...
4. Click **Save**.
<br>
![SNMP Device polling](/images/device-protocols-guide/snmp/snmp-polling.png)
...
![SNMP device measurement graph](/images/device-protocols-guide/snmp/snmp-measurement-graph.png)
