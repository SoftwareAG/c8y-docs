...
For arbitrary protocols, you can configure how LWM2M devices are mapped to Cumulocity IoT using [device protocols](/device-protocols/cloud-fieldbus/#configuring-fieldbus).
