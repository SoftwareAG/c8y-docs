...
Without any further ado, let's start with the customary *Hello world* example. Open the *examples/ex-01-hello/main.cc* file with the following code:
...
![Cumulocity IoT Registration Page](/images/cpp/img/register-deviceID.png)
...
![Cumulocity IoT Registration Page](/images/cpp/img/device-pending.png)
...
![Created device in Cumulocity IoT after integration process](/images/cpp/img/all-devices.png)
...
Now run the program and go to your Cumulocity IoT tenant, execute a restart operation as shown in the image below.
