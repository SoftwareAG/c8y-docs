...
Now that you have done your first step, check out the section [Developing C# clients](/guides/device-sdk/device-sdk-cs/#developing-cs-clients) or examine the [full examples](/guides/device-sdk/device-sdk-cs/#agents).