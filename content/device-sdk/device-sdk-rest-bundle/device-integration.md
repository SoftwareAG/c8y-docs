...
Reference models for the data can be found in the [Device management library](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#section/Device-management-library) and in the [Sensor library](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#section/Sensor-library) in the Cumulocity IoT OpenAPI Specification.
...
For more information, refer to the [Device management library](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#section/Device-management-library) in the Cumulocity IoT OpenAPI Specification.
