...
The {{< product-name-1 >}} C++ SDK offers two message buffering methods in case of connection lost. To switch it, you just need to change the arguments to be parsed to `SrReporter()`. The {{< product-name-1 >}} Linux agent chooses memory-backed buffering by default.
...
This section shows you how to change to file-backed buffering method in the {{< product-name-1 >}} Linux agent. Change from
