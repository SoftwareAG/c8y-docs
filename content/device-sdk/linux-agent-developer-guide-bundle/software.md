...
Before receiving any operation, it sends a list of installed software with message template `319`. You can find the `c8y_SoftwareList` format in the [Device information guide](https://cumulocity.com/api/#section/Device-management-library/Device-information).
