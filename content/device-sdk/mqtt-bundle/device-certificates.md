...
Device can communicate using the MQTT interface of the platform, but MQTT over Websocket is not supported.  
...
* Devices have to be registered or uploaded certificates need to have the flag _autoRegistrationEnabled_ (see below for details).
