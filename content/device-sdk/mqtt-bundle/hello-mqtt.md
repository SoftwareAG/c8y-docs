...
* Username: You need to enter your tenantID and username separated by a slash (tenantID/username). For this example, you can use the same username you use for login to Cumulocity.
