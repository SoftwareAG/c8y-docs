...
|4|Connection refused, bad username or password | Incorrect credentials (wrong username and/or password, but not on empty password. See special cases below). This error is never returned when authenticating with certificates.|
