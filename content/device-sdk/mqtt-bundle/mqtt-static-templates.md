...
For more information, see *c8y_RequiredAvailability* in [Device management library > Device availability](https://www.{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#section/Device-management-library/Device-availability) in the Cumulocity IoT OpenAPI Specification.
