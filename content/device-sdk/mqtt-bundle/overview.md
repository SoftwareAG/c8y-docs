...
> **Info**: For all MQTT connections to our platform, the maximum accepted payload size is 16384 bytes (16KiB), which includes both message header and body. The header size varies, but it's minimum 2 bytes.
