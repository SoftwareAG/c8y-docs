...
* Add a dependency to the MQTT C# client library (in this example we will use [Cumulocity IoT SDK MQTT](https://bitbucket.org/m2m/cumulocity-sdk-cs/src)).
...
Edit the _hello-mqtt-cs.csproj_ in the _hello-mqtt-cs_ folder and add a dependency manually to the Cumulocity IoT SDK MQTT.
...
Now that you have done your first step, check out the section [Hello MQTT](#hello-mqtt) to learn more about Cumulocity IoT MQTT and improve your application.
