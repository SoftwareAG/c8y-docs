...
> **Info**: You may review [Tenants > Tenant ID and tenant domain](https://{{< domain-c8y >}}/api/#tag/Tenants) in the {{< openapi >}} to get a better understanding between tenant ID and tenant domain.
