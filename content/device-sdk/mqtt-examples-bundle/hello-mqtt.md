...
> **Info**: You may review [Tenants > Tenant ID and tenant domain](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#tag/Tenants) in the Cumulocity IoT OpenAPI Specification to get a better understanding between tenant ID and tenant domain.
