...
* Configure the Modbus communication as described in [Optional services > Cloud Fieldbus](/device-protocols/cloud-fieldbus/#configuring-fieldbus) in the Device protocol guide
