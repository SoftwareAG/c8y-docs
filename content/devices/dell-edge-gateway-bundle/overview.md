...
The following document describes how to [configure](#configure) the Edge Gateway for use with Cumulocity and how to [connect](#connect) your gateway to your Cumulocity account.
