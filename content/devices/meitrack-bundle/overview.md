...
For further information, see also the [Software AG Device Partner Portal](https://devicepartnerportal.softwareag.com/dcp-publicweb/#/devices/10033/3).

The following document describes how to [configure](/guides/devices/meitrack/configuration) the Meitrack for use with Cumulocity and how to [connect](/guides/devices/meitrack/configuration) it to your Cumulocity account.
