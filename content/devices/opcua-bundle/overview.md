...
**Important**: The current OPC UA agent is in beta status and not supported by Cumulocity. It will soon be deprecated and replaced by the officially tested and supported OPC UA agent 2.0.
