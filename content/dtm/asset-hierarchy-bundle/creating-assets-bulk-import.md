...
When creating a property, you have the option to assign a default value. If a property's value is left empty in the CSV file during bulk import, its value will be set to default. To override this behavior, enter 'null' as the value in the CSV file. This doesn't set the value and this will be seen as undefined when viewing the asset.
