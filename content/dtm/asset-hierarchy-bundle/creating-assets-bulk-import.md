...
4. On selection, two additional options become available:
...
{{< c8y-admon-info>}}
It is highly recommended to import a maximum of 5000 assets at a time for a better user experience.
{{< /c8y-admon-info>}}
