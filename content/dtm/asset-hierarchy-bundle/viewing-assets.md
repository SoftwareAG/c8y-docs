...
If you edit the asset property or the asset model associated with the selected asset, you see a warning icon next to the asset model name.<br>
...
You can search for assets through the **Search** button <img src="/images/icons/search-icon.png" alt="Search" style="display:inline-block; margin:0"> at the right of the top bar.
