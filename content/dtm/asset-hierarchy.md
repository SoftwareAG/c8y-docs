...
- label: asset-hierarchy
  ...
  To get started, navigate to the **Asset properties** in the **Configuration** menu in the navigator and create the necessary asset properties. Next, navigate to **Asset models** in the **Configuration** menu and create the necessary asset models. Afterwards, navigate back to the **Assets** menu in the navigator and click **Add asset** on the top right corner to create the assets. "
---
