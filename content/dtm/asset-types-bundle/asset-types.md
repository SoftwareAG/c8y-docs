...
Use the downloaded file to import the asset models into DTM application on another tenant.
...
To view the sample, click the menu icon to the right of sample name and click the View option. 
...
{{< c8y-admon-info>}}
When you choose View or Convert to asset model option, the asset model sample undergoes validation. If the validation fails, you see a corresponding message in the dialog. Click **Download log file** to view the errors.
Review the errors that are reported, and attempt the action again after addressing the errors.
{{< /c8y-admon-info>}}