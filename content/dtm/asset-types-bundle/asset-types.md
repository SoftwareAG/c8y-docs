...
To get a quick start to use the DTM application, import pre-defined asset models from **Asset model samples** page. These asset models and associated properties are defined based on best practices and are a contribution from the community. For details about how to import asset models from samples, see [To import asset model samples](#to-import-asset-model-samples).
...
*	**Child asset models**: Comma separated list of child asset models
*  **Asset properties**: Comma separated list of asset properties
...
1. In the **Asset models** page, click **Export asset models**. 
...
4. Click **Export** to export the selected asset models.
5. The dialog closes and a JSON file named 'Export-asset-models.json' downloads.

Use this downloaded file to import the asset models into a DTM application on another tenant.

{{< c8y-admon-info>}}
You can select a maximum of 20 asset models to export at one time.
...
1. In the **Asset models** page, click **Import asset models**.
2. Upload the JSON file in the **Drop file here** section in the resulting dialog. The JSON file is the file containing exported asset models from a DTM application on another tenant. 
...
4. Click **Back** to go to previous step. Hover over the file name and click the delete icon to remove the current file and upload a different one.
3. Click **Import** to import the asset models.
4. View newly imported asset models in the **Asset models** page.
...
Review the errors that are reported, and attempt the import again after addressing the errors.
{{< /c8y-admon-info>}}

### To import asset model samples

When you navigate to **Asset model samples** page following **Configuration > Asset models > Asset model samples**, you see a list of samples with name, description and tags associated with it. 

To view the sample, click the menu icon to the right of sample name and click the View option. Initially, the asset models are collapsed. Click the expand icon to the left of each asset model to view the next level of child asset models.
Click **Import** to import the asset models in the sample.

Alternatively, to import the asset models in the sample without a preview, click the menu icon to the right of sample name and click the Convert to asset model option.
