...
Use this downloaded file to import these asset properties into a DTM application on another tenant.
...
3. Click **Next** to preview the asset properties being imported.
