...
- label: dtm-introduction
  ...
  To get started, open the **Digital twin library** in the **Configuration** menu in the navigator and create the necessary asset models and asset properties. Afterwards, navigate to the **Assets** menu in the navigator and click **Add asset** on the top right corner to create the assets. "
---
