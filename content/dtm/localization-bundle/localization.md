...
- label: localization
  title: Localization
  content: "
  If you want to add translations for the custom property or asset types created, or if you want to add custom translations for the existing static text in the DTM application, you can achieve it by using the Localization feature. 
  ...
  To add a new translation in the DTM application, you can use Add Term in the top menu bar and then add the text as key and add the translations as required. 
