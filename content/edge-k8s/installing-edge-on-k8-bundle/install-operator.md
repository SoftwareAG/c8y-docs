...
To install the Edge operator, run and enter the version (for example, {{< c8y-edge-current-version >}}.0.1) you want to install, and the repository credentials you received along with the license.
