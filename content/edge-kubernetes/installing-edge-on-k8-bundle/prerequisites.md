...
|TLS/SSL key and certificates|Optional. Use your internal or an external Certificate Authority (CA) to generate the TLS/SSL key and certificates. Ensure that the TLS/SSL certificate has the complete certificate chain in the right order.|
