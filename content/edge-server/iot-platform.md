...
|Section|Content|
|:---|:---|
|[Managing assets](/users-guide/cockpit#managing-assets)|Organize assets in [hierarchies](/users-guide/cockpit#asset-hierarchy-versus-device-hierarchy) by [creating groups](/users-guide/cockpit#to-add-a-group) and [assigning devices](/users-guide/cockpit#to-assign-devices-to-a-group).
|[Visualizing data using the Data Explorer](/users-guide/cockpit#data-explorer)|Interactively explore, compare and visualize IoT data. <br> Describes how to access and use the [data explorer](/users-guide/cockpit#data-explorer), [add data points](/users-guide/cockpit#to-add-a-data-point) to the data explorer, [customize data point properties](/users-guide/cockpit#to-customize-data-point-properties), [modify the visualization](/users-guide/cockpit#changing-data-explorer-visualization), store the [data explorer as widget](/users-guide/cockpit#create-widget), and [export](/users-guide/cockpit#to-export-measurement-data) the data.
|[Working with dashboards](/users-guide/cockpit#dashboards)|[Create your own analytics and monitor pages](/users-guide/cockpit#to-create-a-dashboard) by adding and arranging [widgets](/users-guide/cockpit#to-add-a-widget-to-a-dashboard-or-a-report). [Share dashboards](/users-guide/cockpit#to-share-a-dashboard) among all devices of the same type.
...
|[Managing reports](/users-guide/cockpit#reports)|Handle [reports](/users-guide/cockpit#reports) based on dashboard layouts, create [reports for exporting data](/users-guide/cockpit#reporting) in CSV or excel format and [schedule the export](/users-guide/cockpit#to-schedule-an-export).
