...
{{< c8y-admon-important >}}
For information about deployment security best practices and tenant administration security configuration guidelines, see [Security Hardening Guidelines](files/edge/Security_Hardening_Guidelines_guide_1017.pdf).
{{< /c8y-admon-important >}}
