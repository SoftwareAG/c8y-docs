...
Next, you must register a device in the Device Management web app with the name opcua-gateway.
...
In the Device Management web app, click **All devices** in the navigator and find the OPCUA device in the device list.
