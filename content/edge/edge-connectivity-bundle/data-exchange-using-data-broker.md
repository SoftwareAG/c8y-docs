...
{{< c8y-admon-important >}}
Data broker and {{< product-c8y-iot >}} Edge connectivity are compatible only with the current version and previous two releases of {{< product-c8y-iot >}}.
...
To upload the data to a {{< product-c8y-iot >}} tenant account, you must first create a data connector in the {{< product-c8y-iot >}} Edge appliance and subscribe this connector in the tenant account.
...
5. In the tenant account, go to the Administration application. Click **Data broker** > **Data subscriptions** to subscribe the connector created in your {{< product-c8y-iot >}} Edge appliance.
