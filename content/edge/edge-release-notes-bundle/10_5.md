...
* **Custom rules** - After you upgrade to Edge version 10.5, you must upload the custom rules again. The custom rules from an older installation are not migrated automatically during the upgrade process.
