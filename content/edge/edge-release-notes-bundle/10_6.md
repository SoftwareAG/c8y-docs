...
|:---|:---
|CIE-852|On VMware Workstation, you should use UTC on your host machine. If you choose not to use UTC, you may have time sync issues.<br>**Workaround:** Set `rtc.diffFromUTC=0` in the .vmx file.|
