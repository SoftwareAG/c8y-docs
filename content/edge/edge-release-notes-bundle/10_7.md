...
|:---|:---|:---
|CIE-1232|Disk Management|**Limitation:** <ul><li>The data disk can only be expanded three times.</li><li>The installation disk can only be expanded two times.</li></ul>When you expand the data disk size for the first time, the installation disk size also expands even if you have not added more space. This process uses one of the two expansions of the installation disk.   