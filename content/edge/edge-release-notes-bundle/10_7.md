...
|CIE-1102|VNC|**Issue:** The VNC installation and user configuration is lost when you upgrade the Edge VM.<br><br>**Workaround:** Install and configure the VNC components. See [Connecting to the cloud > Accessing the Edge device remotely through VNC](/edge/usage/#accessing-the-edge-device-remotely-through-vnc).
