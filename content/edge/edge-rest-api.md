...
For information about the REST APIs for Edge, see the [{{< openapi >}}](https://{{< domain-c8y >}}/api/edge/).
...
This API is not covered by the general {{< product-c8y-iot >}} API backwards compatibility statement mentioned in [Compatibility policy](/concepts/concepts-introduction/#compatibility-policy).
