...
Use the IP address provided during [network configuration](/guides/edge/installation#configuration). For example, the default value for the Virtual Box is 192.168.56.120.
