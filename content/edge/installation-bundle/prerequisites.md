...
* Ensure that you adhere to the following domain name validation rules:
	...
	* Each segment of the domain name separated by a dot.
		* Must be between 1 to 63 characters long.
