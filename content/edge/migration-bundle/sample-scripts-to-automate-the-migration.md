...
- [restore_analytics.sh](/files/edge/restore_analytics.sh) - restores the Streaming Analytics web app.
...
4. Run the `restore_analytics.sh` script. This script restores the Streaming Analytics web app.
