...
If it shows up as disabled, enable the microservice hosting feature through [the GUI](/edge/configuration/#enabling-or-disabling-the-microservice-hosting-feature-using-the-ui) or [the REST API](https://cumulocity.com/api/edge/10.18.0/#tag/Microservice-hosting-feature).
