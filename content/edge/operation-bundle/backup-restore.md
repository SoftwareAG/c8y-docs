...
1. To power off the VM, right-click on the respective VM (e.g. EDGE-server) in the VirtualBox Manager click **Close** and then **Power off**.<br><br>
...
<br>
2. In the upcoming window, enter the location and name as desired and click **Export**.<br><br>
...
<img src="/images/edge/edge-restore2.jpg" name="Restore Edge" style="width:75%;"/> 
<br>
