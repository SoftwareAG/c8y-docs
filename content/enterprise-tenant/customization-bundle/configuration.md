...
|{username}|Will be replaced with the value of the username property specified in the user configuration, see [User options and settings](/users-guide/get-familiar-with-the-ui/#user-settings).|
