...
|_mode|String|The processing mode in which the data was sent to Cumulocity. See <b>Processing mode</b> in the [Cumulocity IoT OpenAPI Specification](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/#section/REST-implementation/HTTP-usage).|
