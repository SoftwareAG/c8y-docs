...
The inMaintenaceMode() function is a fast way to check if the device is currently in maintenance mode. It takes an [ID](/guides/event-language/data-model#id) as parameter and will return a boolean value.
...
For more information about timer patterns please check [here](/guides/event-language/advanced-cel).
