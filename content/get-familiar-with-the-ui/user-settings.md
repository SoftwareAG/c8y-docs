...
- The ID of your tenant, which might be required if you request support. Click the copy icon <i class="dlt-c8y-icon-paste1"></i> next to the tenant ID to copy it to the clipboard.
