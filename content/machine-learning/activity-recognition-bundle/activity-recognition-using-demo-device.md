...
2. Follow the steps described in [ Machine Learning Workbench > Projects > Uploading resources](/machine-learning/web-app-mlw/#uploading-resources) and upload all the files extracted to Machine Learning Workbench (MLW). You will get 2 files in Data Section and 3 Notebooks in Code section. Exclude the PMML file and .mon file.
...
2. Execute each cell one by one and you will have a registered device in Cumulocity, upon successful execution, a device named **DemoDevice** is registered in Cumulocity IoT. 
...
1. Open it, click edit icon <img src="/images/zementis/mlw-edit-icon.png" alt="Edit" style="display:inline-block; margin:0">.
2. Execute each cell one by one and you will have a registered device in Cumulocity, upon successful **c8y_Acceleration** measurements are sent to Cumulocity IoT on behalf of the demo device. The measurements are simulated dynamically for the current date in gap of 1 seconds.
