...
---
Upload the project ZIP file to {{< product-c8y-iot >}} Machine Learning Workbench. We have added a *CONFIG.json* file to the project. This file is meant for capturing the tenant details and credentials which will be used by the demo scripts.
