...
* Subscription of the {{< product-c8y-iot >}} Machine Learning Workbench microservice (10.13.0.x.x or higher), Zementis microservice (10.5.0.x.x or higher) and the Machine Learning application on the tenant.
