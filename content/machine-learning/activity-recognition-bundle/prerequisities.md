...
* Subscription of the {{< product-c8y-iot >}} Machine Learning Workbench microservice (10.13.0.x.x or higher), Zementis microservice (10.5.0.x.x or higher), the Machine Learning Workbench web app and the Machine Learning web app on the tenant.
* Subscription of the Apama-ctrl microservice and the Apama-epl web app on the tenant.
