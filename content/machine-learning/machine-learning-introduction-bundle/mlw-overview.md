...
Machine Learning Workbench enables data scientists and machine learning engineers to build, train and evaluate high quality machine learning models using intuitive, easy to use, no-code graphical user interface and a programmer-friendly Jupyter Notebook based environment. Machine Learning Workbench provides seamless access to data residing in Cumulocity operational store or any cloud data lakes with visual tools to ingest and transform the data.
