...
<div style="padding: 24px ; border: 2px solid #1776BF; border-radius: 4px; margin-bottom: 24px; background-color: #f6fafe ">
  ...
  <p class="lead" style="font-size:22px"> The release notes for {{< product-name-1 >}} Machine Learning have been moved to a new <a href="https://cumulocity.com/guides/releasenotes/about">release notes page</a>:</p>
