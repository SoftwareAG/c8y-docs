...
It is important to mention that `C8Y_BASEURL` allows access only to the microservice's REST endpoints. Hence, a microservice cannot retrieve information from UI applications.
