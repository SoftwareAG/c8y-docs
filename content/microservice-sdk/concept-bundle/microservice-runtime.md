...
When using Java-based microservices this variable is automatically read and applied to the Java process, no additional work is required. Other microservices like Python-based may require some manual work.
