...
The following requirements towards {{< product-name-1 >}} microservices must be met:
...
* All persistent states must be stored at the {{< product-name-1 >}} platform via inventory, binary, tenant options and other APIs. Persistent volumes are not supported.
* A microservice cannot access the database directly and must use the {{< product-name-1 >}} API.
