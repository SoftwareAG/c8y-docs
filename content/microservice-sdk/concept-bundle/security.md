...
There is a mechanism to encrypt the tenant options that afterwards are automatically decrypted when injecting them into microservices requests. Refer to [Option collection](/reference/tenants#option-collection) in the **Tenants** section of the **Reference** guide for more details.
