...
{{< product-c8y-iot >}} provides an SDK for developing microservices using Java. Nevertheless, you are free to select the tech-stack of your preference to develop a microservice as long as it fulfills the [general requirements](/microservice-sdk/general-aspects/#requirements).
