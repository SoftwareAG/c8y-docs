...
Microservices are server-side applications which may be used to extend the {{< product-name-1 >}} platform with customer-specific functionality.
...
* [General aspects](/microservice-sdk/concept) and functionality of using microservices on top of {{< product-name-1 >}}
