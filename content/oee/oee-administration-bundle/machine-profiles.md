...
The location indicates where the machine is located. It is used to apply a shift plan to this profile. See the [Shift Plans](shiftplan.md) section for more details regarding shift plans and the calculation implications.
