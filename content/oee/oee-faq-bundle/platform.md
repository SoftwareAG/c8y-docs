...
`
###  Why does a measurement/event/alarm in the OEE web app have multiple timestamps?
...
1. Go to the parent machine in the Device Management web app and open the child devices of the machine.
...
Alternatively, you can also use the built-in search in the Device Management web app to search for the name of the profile.
