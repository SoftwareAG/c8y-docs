...
This guide provides detailed information on the functionalities of the [Predictive Analytics application](/predictive-analytics/web-app) and a comprehensive listing of [REST API](/predictive-analytics/api-reference) exposed by the Zementis microservice.