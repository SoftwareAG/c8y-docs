...
The inferences pop-up would show two different types of charts, a histogram plotting all the model’s continuous outputs and a pie-chart plotting the model’s categorical outputs. 
