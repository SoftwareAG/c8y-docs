...
* Conversion of values is extended by an offset parameter (may be any positive or negative number). This will be added or substracted from the register value, depending on its sign. The offset calculation is done after applying multiplier and divisor, and before performing decimal shifting.
