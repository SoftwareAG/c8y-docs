...
For the following instructions, it is assumed that you have a Cloud Fieldbus terminal available and it is registered as a device in your {{< product-name-1 >}} tenant. To register a terminal with {{< product-name-1 >}}, follow the instructions provided with the terminal.
...
6. Change the transmit rate and the polling rate according to your requirements. The transmit rate is the frequency where measurements are sent to {{< product-name-1 >}}. The polling rate is the frequency at which the Modbus devices are polled for changes.
...
3. Click **Add**. {{< product-name-1 >}} will now send a notification to the Modbus terminal that a new device is ready to be managed. This may take a few seconds.
...
5. Change the transmit rate and the polling rate according to your requirements. The transmit rate is the frequency at which measurements are sent to {{< product-name-1 >}}. The polling rate is the frequency at which the Modbus devices are polled for changes.
...
{{< product-name-1 >}} will now send a notification to the Modbus terminal that a new device is ready to be managed. This may take a few seconds.
...
5. Change the transmit rate according to your requirements. The transmit rate is the frequency where measurements are sent to {{< product-name-1 >}}.
6. Click **Save** to save your settings.
...
{{< product-name-1 >}} will now send a notification to the fieldbus terminal that a new device is ready to be managed. This may take a few seconds.
...
4. Change the transmit rate according to your requirements. The transmit rate is the interval at which measurements are sent to {{< product-name-1 >}}.
...
{{< product-name-1 >}} will notify the gateway to send data for the newly created child device.
