...
To process data from LoRa devices, {{< product-c8y-iot >}} must understand the payload format of the devices. Mapping payload data to {{< product-c8y-iot >}} data can be done by creating a LoRa device protocol.
