...
To process data from LoRa devices, {{< product-name-1 >}} needs to understand the payload format of the devices. Mapping payload data to {{< product-name-1 >}} data can be done by creating a LoRa device protocol.
