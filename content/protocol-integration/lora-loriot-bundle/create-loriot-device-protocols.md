...
In order to create a device protocol, navigate to the Device Management web app and select **Device protocols** in the **Device types** menu in the navigator. You can either import an existing device protocol or create a new one.
