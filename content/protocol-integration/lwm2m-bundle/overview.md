...
{{< c8y-admon-req >}}
In order to use LWM2M, you must be subscribed to the LWM2M-agent application. If the LWM2M-agent is not available in your tenant, [contact product support](/welcome/contacting-support/).
{{< /c8y-admon-req >}}

{{< c8y-admon-info >}}
LWM2M Agent support DTLS Connection ID. Contact your platform administrator if you use LWM2M devices that supports connection IDs and unsure if this feature is enabled.
{{< /c8y-admon-info >}}
