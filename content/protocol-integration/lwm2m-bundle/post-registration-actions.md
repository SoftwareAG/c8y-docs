...
More information on shell commands can be found in [Handling LWM2M shell commands](/protocol-integration/lwm2m-bundle/shell-commands.md) in the <em>Protocols integration guide</em>.
