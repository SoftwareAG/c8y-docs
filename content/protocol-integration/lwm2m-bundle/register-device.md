...
<td style="text-align: left">String</td>
<td style="text-align: left">Indicates the encoding format used while pushing the firmware binary during the LWM2M firmware update.
The encoding format can be either "OPAQUE" or "TLV" or "JSON" or "TEXT". In case of empty or invalid entries,
