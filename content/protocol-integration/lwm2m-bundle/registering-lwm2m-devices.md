...
Refer to [Device settings](#lwm2m-device-registration-device), [Security settings](#lwm2m-device-registration-security),
...
#### Device settings {#wm2m-device-registration-device}
...
#### Security settings {#wm2m-device-registration-security}
...
<td style="text-align: left">String</td>
<td style="text-align: left">X.509 device certificate (in PEM format) written to device during bootstrap phase. Empty value means that it won't be written at all.</td>
