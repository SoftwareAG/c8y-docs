...
A UA event mapping defintion is needed to catch these events and convert them to an internal alarm.
...
```json
{
    "description": "Generate ua event 1",
    "deviceId": "129",
    "c8y_ua_command_CallMethodOperation": {
        "request": {
            "nodeId": "ns=2;s=HelloWorld/generateEvent(eventTypeId, nodeId, severity)",
            "arguments": [
            {
                "name": "EventTypeId",
                "description": "NodeId of the TypeDefinition of the event to generate.",
                "dataType": "NodeId",
                "dataTypeId": "nsu=http://opcfoundation.org/UA/;i=17",
                "value": "i=2915"
            },
            {
                "name": "NodeId",
                "description": "Event source node ID",
                "dataType": "NodeId",
                "dataTypeId": "nsu=http://opcfoundation.org/UA/;i=17",
                "value": "i=2253"
            },
            {
                ...
                "dataType": "Int16",
                "dataTypeId": "nsu=http://opcfoundation.org/UA/;i=4",
                "value": "2"
            },
            {
                "name": "Additional parameters",
                "description": "Alarm properties",
                "dataType": "String",
                "dataTypeId": "nsu=http://opcfoundation.org/UA/;i=12",
                "value": "{\"AckedState\": \"Unacked\", \"ConfirmedState\": \"Confirmed\", \"EnabledState\": \"Enabled\", \"ActiveState\": \"Active\"}"
            }
            ]
        }
    }
...
```
Example call to set to ACTIVE (if not yet done) and ACKNOWLEDGE
```json
  {
  "description": "Generate and acknowledge ua event 1",
  "deviceId": "129",
  "c8y_ua_command_CallMethodOperation": {
    "request": {
      "nodeId": "ns=2;s=HelloWorld/generateEvent(eventTypeId, nodeId, severity)",
      "arguments": [
        ...
        },
        {
          ...
          "dataType": "String",
          "dataTypeId": "nsu=http://opcfoundation.org/UA/;i=12",
          "value": "{\"AckedState\": \"Acked\", \"ConfirmedState\": \"Confirmed\", \"EnabledState\": \"Enabled\", \"ActiveState\": \"Active\"}"
        }
      ]
    }
  }
...
```
Example call to set an alarm to CLEARED
```json
{
    "description": "Clear ua event 1",
    "deviceId": "129",
    "c8y_ua_command_CallMethodOperation": {
        "request": {
            "nodeId": "ns=2;s=HelloWorld/generateEvent(eventTypeId, nodeId, severity)",
            ...
            },
            {
                ...
                "dataType": "String",
                "dataTypeId": "nsu=http://opcfoundation.org/UA/;i=12",
                "value": "{\"AckedState\": \"Acked\", \"ConfirmedState\": \"Confirmed\", \"EnabledState\": \"Enabled\", \"ActiveState\": \"Cleared\"}"
            }
            ]
        }
    }
