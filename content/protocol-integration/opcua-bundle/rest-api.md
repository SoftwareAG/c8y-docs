...
<td>integer</td>
<td>no</td>
<td>For cyclic reads, this defines how many nodes that can be read at once from the OPC UA server. This is applicable only for nodes that were resulted of the application from the same device type, matching root node and sharing the same reading parameters (rate and max age). Default is 1000 as defined in the application yaml file.</td>
</tr>
</tbody>
</table>                                                                                                                                         |
