...
The type of the alarm is constructed as `c8y_ua_DataValueAbnormal_<nodeId>_<StatusCode>_<value>`. It is created once and saved to the server managed object to avoid frequent alarms 
in case of short data reporting interval.