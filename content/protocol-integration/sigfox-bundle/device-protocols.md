...
To create device protocols, select **Device protocols** in the **Device types** menu in the navigator of the Device Management web app. You can either import an existing device protocol or create a new one.
