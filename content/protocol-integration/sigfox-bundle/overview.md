...
{{< c8y-admon-info >}}
To be able to use the Sigfox agent, your tenant must be subscribed to the application sigfox-agent. In case of any issues, please contact [product support](/welcome/contacting-support/).
{{< /c8y-admon-info >}}
