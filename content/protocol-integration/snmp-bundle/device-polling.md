...
The data received via polling is mapped to the {{< product-name-1 >}} model based on the mapping defined. As the OIDs contain measurement mapping, the measurements can be viewed in the **Measurements** tab of the SNMP device.
...
#### Which {{< product-name-1 >}} services does the agent use?
