...
![Subscribed web apps](/images/device-protocols/snmp/snmp-mib-zipfile-structure.png)
2. In the Device Management web app, click **Device protocols** in the **Device types** menu in the navigator.
