...
1. In the Device Management web app, click **Registration** in the **Devices** menu in the navigator.
...
5. If the agent process is started and the device ID is correct you will see an **Accept** button. If the agent is not started, start the agent web app. Click **Accept** to complete the registration process.
...
**Step-1:** Create a new device request:
	...
	Authorization: Basic ...
	Content-Type: web app/vnd.com.nsn.cumulocity.newdevicerequest+json
    {
