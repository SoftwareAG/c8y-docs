...
The response will additionally to the alarm object contain a "realtimeAction" to identify which action resulted in the given object (CREATE or UPDATE). In case of alarm deletion (DELETE) there will be no notification.
