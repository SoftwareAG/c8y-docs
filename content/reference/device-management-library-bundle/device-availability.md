...
The platform considers the creation of measurements, events, alarms as well as empty managed object updates as the device's heartbeat. These requests will mark the device as available.
