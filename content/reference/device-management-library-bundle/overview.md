...
To start with device management, open the **All devices** tab in the **Devices** menu of the Device Management web app. Click on a device in the list to open the device details of this particular device. You will see various tabs and particular information on each of them.
...
<td>Sends data to the <strong>Network</strong> tab in the Device Management web app and displays the network information</td>
</tr>
<tr>
