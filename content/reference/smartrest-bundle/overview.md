...
<!--
based on microservice sdk smartrest.md
TODO: make this independent from HTTP and SR1
Explain goals
Explain the general idea of sending CSV data that is brought in context by a template
Explain benefits
 -->
