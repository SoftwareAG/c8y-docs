...
You must know the ID of the device object to update data in it via REST. Also, this ID is required for every other data that is to be associated with the device, for example, the source in a measurement, alarm or event.
