...
<td>
Cockpit</td>
<td > A map widget placed in a group dashboard will now have the same limit of displayed devices as a map widget placed in an overview dashboard; otherwise it would fail to load any devices because the constructed URL could exceed request size limits.</td>
<td>
MTM-38765</td>
</tr>
