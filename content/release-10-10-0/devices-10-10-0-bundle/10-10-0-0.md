...
<td>
OPC UA</td>
<td > OPC UA now supports regular expressions in browse path mappings. For details, see <a href="/protocol-integration/opcua/#device-protocols" class="no-ajaxy"<OPC UA > Device protocols</a> and <a href="/protocol-integration/opcua/#rest-api" class="no-ajaxy"<OPC UA > Rest API</a>&gt; in the <i>Protocol integration guide</i>.</td>
<td>
MTM-38009</td>
</tr>
...
<td>
OPC UA</td>
<td > Inventory update processing modes for OPC UA-related managed objects can now be configured in the gateway. </td>
<td>
MTM-38279</td>
</tr>
