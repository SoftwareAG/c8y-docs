...
<td>
OPC UA</td>
<td > The OPC UA microservice provides an OpenAPI documentation. The API can now be directly accessed using the "try out" functionality of the Swagger UI. </td>
<td>
MTM-37219</td>
</tr>
