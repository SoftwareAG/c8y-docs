...
* The data pull feature from the Cumulocity IoT DataHub in Cumulocity IoT Machine Learning Workbench is supported on Cumulocity IoT Edge from 10.11 release onwards.
