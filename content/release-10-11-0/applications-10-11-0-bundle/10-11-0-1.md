...
<td>
Web SDK</td>
<td> When the globalTitle was not defined, the title was displayed as "undefined" in the UI. Now there is a fallback template for the page title, in case the globalTitle is not defined. The new displayed title will no longer be "undefined".</td>
<td>
MTM-41107</td>
</tr>
