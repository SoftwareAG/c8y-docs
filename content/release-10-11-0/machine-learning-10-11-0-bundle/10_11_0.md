...
- Bug fixes:
  ...
  - Fixed the issue where in certain scenarios the Zementis microservice would fail to start if it encountered errors while restoring existing artifacts.
...
- Enhancements:
  ...
  - Improve project commit/pull experience:
    ...
    - Control switches to the Projects page when a commit is performed. Control remains on the Projects page when a version pull is initiated.
