...
<td>
Administration</td>
<td> The <b>New tenant</b> window had some overlapping style issues on the <b>Storage per device<7b> field, which is only shown if the functionality is enabled for the current tenant. These issues have been fixed.</td>
<td>
MTM-41498</td>
</tr>
