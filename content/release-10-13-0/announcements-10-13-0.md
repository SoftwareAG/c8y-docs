...
* The API to download the serialized source of a PMML model `{{url}}/service/zementis/model/{{model_name}}/serialized` will be a NO_OP starting 10.13 release and will be removed in 10.15 release.
