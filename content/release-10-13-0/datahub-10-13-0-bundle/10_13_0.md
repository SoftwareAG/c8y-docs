...
Cumulocity IoT DataHub now uses version 19.3 of Dremio as query engine. The new version comes along with various features and improvements.
...
The user interface was improved with respect to the handling of large sets of artifacts, including job history, offloading status, and offloading configuration entries.
