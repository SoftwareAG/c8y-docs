...
<td> A new log file related to devices availability monitoring has been created. The log file is by default disabled. The purpose of the log file is to trace communication between the device and the Cumulocity IoT platform. For details, see <i>Log files</i> in the <i>Cumulocity IoT platform - Operations guide</i>. </td>
<td>
MTM-36556</td>
</tr>
