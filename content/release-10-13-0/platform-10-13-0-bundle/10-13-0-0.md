...
<!--10.11.1.0 - 10.11.163.0; 10.13.0.0-10.13.0.3-->
...
<td>
<b>NEW:</b> Administration</td>
<td> The navigation in the single sign-on authentication and Enterprise tenant configuration pages has been improved. All actionable elements are now visible without too much scrolling, for example, the enabled <b>Save</b> button is immediately visible after settings have been changed, instead of scrolling to the bottom of a long page. Moreover, the layout of these pages was made consistent with the rest of the UI.</td>
<td>
MTM-41905</td>
<td>
</tr>
...
<td>
<b>NEW:</b> Authentication</td>
<td> The capabilities of session-based token authentication were extended so that it can be used as a replacement for basic authentication for web applications that are working in web browsers. Moreover, it is possible to restrict the usage of basic authentication by web browsers on the tenant level to gain a more secure configuration. Session-based token authentication will be set up as the default login mode for a newly created tenant. </td>
<td>
MTM-39656</td>
</tr>
...
<tr>
<td>
<b>NEW:</b> Cloud Remote Access</td>
...
<td>
<b>NEW:</b>Security</td>
<td> Updated vulnerable libraries to safe versions: jackson-databing to v2.10.5.1 and ehcache to v2.10.9.2. </td>
<td>
MTM-40685</td>
</tr>
...
<td>
<b>NEW:</b> Authentication</td>
<td> If the login mode is OAuth Internal, the user now must logout after password change. A confirmation dialog shows up in which the user confirms to be logged out to apply the new password. The change is added in the user settings and the user details view for the current user.</td>
<td>MTM-43440</td>
</tr>

<tr>
<td>
<b>NEW:</b> CEP (Esper)</td>
