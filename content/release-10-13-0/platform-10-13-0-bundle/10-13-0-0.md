...
<br>- Preconfigured authentication restrictions so that basic authentication cannot be used together with HTTP clients which are recognized by the Cumulocity IoT platforms, for example web browsers
<br>- Preconfigured session management feature including default values of various timeouts associated with sessions
<br>- The maximum number of simultaneous user's logons is limited
