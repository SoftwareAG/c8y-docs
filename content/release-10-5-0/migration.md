...
Note that retention rules still apply to audit logs and will delete audit log records older than the specified retention time, see also <em>Auditing > Audit record collection</em> in the <em>Reference guide</em>. 
...
For details on migration, refer to <em>Migrating from CEL (Esper) to Apama</em> in the <em>Streaming analytics guide</em>.