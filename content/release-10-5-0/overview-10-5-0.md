...
These release notes for **Cumulocity IoT release 10.5.0, October 2019**, include all relevant changes (migration notes, improvements and fixes) that have been implemented in Cumulocity IoT Core, Cumulocity IoT Edge, Cumulocity IoT Streaming Analytics, Cumulocity IoT Predictive Analytics, and Cumulocity IoT DataHub since the previous GA release.
