...
You can perform the migration using the manual steps or using the sample scripts provided in the software. You may customize these scripts for your requirements and automate the migration process. For more information, see [Migrating Edge 10.7 to 10.9](https://cumulocity.com/guides/edge/migration/#migration-107-to-109).
