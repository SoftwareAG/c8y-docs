...
<td>
Two-factor authentication</td>
<td> Issue resolved where the preferred login mode has not been updated after re-login. The user no longer needs to refresh after re-login to display the correct login mode.</td>
<td>
MTM-40778</td>
</tr>
</tbody></table></div>
