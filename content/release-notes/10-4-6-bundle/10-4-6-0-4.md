...
For further details on Apama streaming analytics, refer to the <em>Streaming analytics guide</em>.
...
For details, see <em>Device Management > Grouping devices</em> in the <em>User guide</em>.
