...
[**Administration**] In the **Logs** tab, It is now possible to jump to the beginning and the end of logs via navigation buttons. [MTM-27530]
![Navigation buttons](/guides/images/release-notes/navigation-buttons.png)
...
<tr>
<td style="text-align:left">Administration</td>
<td style="text-align:left">Microservice logs can now be properly downloaded from the **Logs** tab of an application.</td>
