...
[UI] New **Legal notices** item has been added to the right drawer menu.
...
<td style="text-align:left"><strong>Login alias</strong> field validation in the user details page is now available.</td>
