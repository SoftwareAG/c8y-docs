...
[**Administration**] There is a new warning message for the users, when there are no available logs. [MTM-29450]
...
[**OPC UA**] It is now easier to analyse issues during the auto apply procedure. The following improvements have been added [MTM-29837]:
- “c8y_ua_DeviceTypeApplied” event is now triggered when a device type is applied to a node server.
...
- “c8y_ua_command_TestDeviceTypeMatching” operation has been added to tell if a node (root node) matches and will be applied to a device type or not, if not then why.
...
<td style="text-align:left">Missing translation for the data broker alert messages have been added.
</td>
<td>MTM-28383</td>
</tr>
<tr>
