...
[**Administration**] Usability in the **Log** tab of subscribed applications has been further improved. The date specifying the time range can now be selected from a calendar and the theme can be selected through a toggle.
