...
For details on the Cumulocity Microservice SDK for Java, see [Microservice SDK for Java](https://cumulocity.com/microservice-sdk/java/) in the Microservice SDK guide.
