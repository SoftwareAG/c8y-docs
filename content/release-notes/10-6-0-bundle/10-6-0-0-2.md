...
<td style="text-align:left">Regular users are now being created as device users in order to bypass password expiry. Moreover, passwords are being generated in a more secure way using the 3rd-party library org.passay (which uses SecureRandom internally).
</td>
<td style="text-align:left">MTM-29449</td>
</tr>
<tr>
