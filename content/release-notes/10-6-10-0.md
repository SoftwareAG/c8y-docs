...
<td>
Cockpit</td>
<td > To improve performance, requests to inventory&nbsp; to check if the user has permission (ContextGuard) now use the "withChildren:false" parameter. </td>
<td>
MTM-32482</td>
</tr>
...
<td>
Cockpit</td>
<td > To improve performance, in both Device Management and Cockpit, in the sub-assets view of group details, the objects are now fetched from inventory using the childAssets endpoint instead of the advanced querying (in-group). </td>
<td>
MTM-32441</td>
</tr>
