...
<tr>
<td>Data Broker</td>
<td>Improvements in data broker functionality: The exception handling has been improved. After suspending a connector, the data broker stops forwarding immediately.</td>
<td>
MTM-30913</td>
</tr>
<tr>
...
<td>
Enterprise Tenant</td>
<td>Now certificates issued by less known intermediate CAs are also supported as certificates for custom domains and can be uploaded with the full certificate chain.</td>
<td>
MTM-27401</td>
</tr>
<tr>
...
<td>
MQTT</td>
<td>  An error is published to the error channel whenever an illegal operation is used for a device by using MQTT.</td>
<td>
MTM-30555</td>
</tr>
<tr>
