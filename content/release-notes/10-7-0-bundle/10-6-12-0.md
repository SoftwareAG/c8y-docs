...
<td>
Billing</td>
<td > The microservice resource usage returned by the tenant usage statistics API has been documented, see <a href="/reference/tenants#tenant-usage-statistics" class="no-ajaxy">Tenants > Tenants usage statistics</a> in the <em>Reference guide</em>. </td>
<td>
MTM-33623</td>
</tr>
