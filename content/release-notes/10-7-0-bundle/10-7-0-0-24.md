...
<td>
Device Management</td>
<td > Devices for bulk operations can now be filtered by subgroups. For details, see <a href="/users-guide/monitoring-and-controlling-devices/#operation-monitoring" class="no-ajaxy">Device Management > Monitoring and controlling devices > Working with operations </a> in the <em>User guide</em>. </td>
<td>
MTM-31154</td>
</tr>
