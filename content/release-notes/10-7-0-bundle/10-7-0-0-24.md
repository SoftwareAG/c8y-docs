...
<td>
Billing</td>
<td> To ensure parity in the billing for customers the request counting in SmartREST and MQTT is now more consistent. The behaviour now matches that for the REST interface. For details see the <a href="https://cumulocity.com/api/#tag/Tenant-API" class="no-ajaxy">Tenant API</a> in the <em>Cumulocity IoT OpenAPI Specification</em>.</td>
<td>
MTM-32970</td>
</tr>
...
<td>
Device Management</td>
<td > An endpoint has been added to allow forcing the general status of a bulk operation to SUCCESSFUL. For details, see <a href="https://cumulocity.com/api/#tag/Bulk-operations" class="no-ajaxy">Device control > Bulk operation</a> in the <em>Cumulocity IoT OpenAPI Specification</em>.</td>
<td>
MTM-33151</td>
</tr>
...
<td>
Documentation</td>
<td > Updated documentation for an edge case when loading managed objects without inventory role, see <a href="https://cumulocity.com/api/#tag/Managed-objects" class="no-ajaxy">Inventory > Managed object collection</a> in the <em>Cumulocity IoT OpenAPI Specification</em>. </td>
<td>
MTM-33763</td>
</tr>
...
<td>
MQTT</td>
<td > Requests made with JSON via MQTT are counted to the tenant statistics. For details see, <a href="https://cumulocity.com/api/#tag/Tenants" class="no-ajaxy">Tenants > Tenants</a> in the <em>Cumulocity IoT OpenAPI Specification</em>.</td>
<td>
MTM-34123</td>
</tr>
