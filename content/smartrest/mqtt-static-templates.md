...
For more information, see *c8y_RequiredAvailability* in [Device integrator library > Device availability](/reference/device-integrator-library/#device-availability).
