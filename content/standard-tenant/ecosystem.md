...
- [Application enablement & solutions > Web SDK](/web/websdk-introduction/) for information on how to develop web applications on top of {{< product-c8y-iot >}} and how to [customize](/web/application-configuration) existing applications.
