...
In Cumulocity IoT, events, alarms and operations are used as the sources of pulses. See also the following topics in the Cumulocity IoT documentation: [Events](/concepts/domain-model/#events) and [Operations](/concepts/domain-model/#operations) in the *Concepts guide* and [Device management library > Alarms](/reference/device-management-library/#alarms) in the *Reference guide*.
