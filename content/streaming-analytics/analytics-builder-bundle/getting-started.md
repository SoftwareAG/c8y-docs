...
3.  Click the three dots that are shown for **Input Source**. In the resulting dialog box, click the **Choose device** button to select your device. This button is shown when you move the mouse over a device.
