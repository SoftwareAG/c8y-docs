...
|`chain_diagnostics`|Information about model chains. See [Connections between models](/streaming-analytics/analytics-builder/#connections-between-models) for more information.|
