...
1.  In the model editor, click on the model name which is shown at the left of the toolbar. If you have added the model without specifying a model name, the default name "Model#" is shown.
