...
Each card that is shown for a model has an actions menu <i class="dlt-c8y-icon-menu-vertical text-muted icon-20"></i> at the top right which contains commands for managing the model \(for example, to download or remove the model\).
...
1.  On the **Models** tab of the model manager, click the actions menu <i class="dlt-c8y-icon-menu-vertical text-muted icon-20"></i> of the model that you want to remove and then click **Remove**.
