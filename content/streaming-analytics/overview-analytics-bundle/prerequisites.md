...
This is typically achieved by using a global role which has those permissions, and where the role has access to the Analytics Builder application. See [Managing permissions](/standard-tenant/managing-permissions/) in the *User guide* for details.
