...
Command [`tedge mqtt pub`](/thin-edge/thin-edge-developer-tools/#pub) can be used to publish MQTT messages on a topic to the local mosquitto server.
...
Command [`tedge mqtt sub`](/thin-edge/thin-edge-developer-tools/#sub) can be used to ease debugging of of MQTT communication on local bridge. You can subscribe to topic of your choosing:
