...
You can now use [`tedge` command](/thin-edge/thin-edge-developer-tools/#tedge) to:
...
see the reference guide of [`tedge cert`](/thin-edge/thin-edge-developer-tools/#tedge-cert).
