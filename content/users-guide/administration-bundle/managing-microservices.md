...
helpcontent:
  - label: microservices
    ...
    Click on a microservice to view the application properties. To add a microservice, click **Add microservice** and follow the instructions in the wizard, see also *Administration > Managing microservices > To add a microservice as custom application* in the *User guide*."
---
