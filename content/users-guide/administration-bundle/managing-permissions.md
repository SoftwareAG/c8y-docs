...
The improvements are disabled by default in version {{< c8y-current-version >}}. Activate them on tenant level by using the tenant option. See the relevant [release notes entry](https://cumulocity.com/releasenotes/release-10-13-0/whatsnew-10-13-0/#inventory-roles-performance-improvement) for details.
