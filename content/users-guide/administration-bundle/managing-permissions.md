...
> **Info:** Service providers will see an additional permission "Support" in their {{< tenant-type-3 >}}. This permission lets users of the service provider give support to their customer's users, see [Support user access](/users-guide/enterprise-edition/#support-user-access).
