...
The following steps illustrate how to use Azure AD (Azure Active Directory) for single sign-on in {{< product-c8y-iot >}}.
...
### Configuring single sign-on for Azure AD In Cumulocity IoT
