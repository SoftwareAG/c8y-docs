...
helpcontent:
  - label: data-explorer
    title: Data explorer
    content: "In the data explorer, data points, for example, measurements or sensor data, can be visualized. On the right, you see a list of available data points. On the left you see its visualization.
...
In the data explorer, data points, for example, measurements or sensor data, can be visualized.
