...
|[Managing reports](#reports)|Handle [reports](#reports) based on dashboard layouts, create [reports for exporting data](#create-reports) in CSV or excel format and [schedule the export](#schedule-export). 
