...
|[Managing reports and exports](#reports)|Handle [reports](#reports) based on dashboard layouts, create [reports for exporting data](#export) in CSV or excel format and [schedule the export](#schedule-export). 
