...
With version 10.6.2, a new report agent has been implemented to allow scheduled reports with the [Streaming Analytics application](/apama/overview-analytics/). The export schedules functionality based on smart rules has been deprecated.
