...
{{< c8y-admon-related >}}
- [Device management > Monitoring and controlling devices > Working with alarms](/users-guide/device-management/#alarm-monitoring) for details on alarms in {{< product-c8y-iot >}}.
