...
{{< c8y-admon-related >}}
* [Device management library > Connectivity](/reference/device-management-library/#connectivity) in the *Reference guide* for the device management library entry on connectivity.
