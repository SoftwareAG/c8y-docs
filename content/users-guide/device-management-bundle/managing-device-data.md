...
{{< c8y-admon-info >}}
This section describes how to manage trusted certificates. For information on connecting devices using certificates refer to [Device integration using MQTT > Device certificates](/device-integration/mqtt#device-certificates) in the *Device SDK guide*.
{{< /c8y-admon-info >}}
