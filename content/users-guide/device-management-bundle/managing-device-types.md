...
For details on configuring device protocols, follow the documentation of the particular device type you want to create, see [Device protocol guide](/device-protocols/overview).
5. Click **Save**.
...
Details on the fields can be found in the documentation of the particular device type, see [Optional services](/device-protocols/overview).
