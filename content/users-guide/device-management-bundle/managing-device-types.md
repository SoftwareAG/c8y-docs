...
* [LPWAN Custom device protocols](/protocol-integration/lpwan-custom-codec/) in the *Protocol integration guide* for details on custom device protocols for LPWAN devices.
{{< /c8y-admon-related >}}
