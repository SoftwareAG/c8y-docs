...
|[Managing device data](#managing-device-data)|How to retrieve and manage [firmware and software](#software-repo) for devices, [configuration snapshots](#configuration-repository), [trusted certificates](#managing-trusted-certificates) and [device credentials](#credentials).
