...
|[Managing device data](#managing-device-data)|How to manage [firmware and software](#software-repo) for devices, [configuration snapshots](#configuration-repository), [device credentials](#credentials), [trusted certificates](#managing-trusted-certificates) and [device profiles](#device-profiles).
