...
* you have added a wildcard CNAME record (starting with `*.`) to your DNS server of the following format:<br>
 ...
 Type = CNAME <br>
 Target = the domain of the platform you want to point to, e.g. if you use *https&#58;//demo.cumulocity.com* to access your tenant, use "demo.cumulocity.com" as target.<br>
