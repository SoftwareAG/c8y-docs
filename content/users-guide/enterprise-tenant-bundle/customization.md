...
|{username}|This placeholder will be replaced with the value of username property specified within user configuration, see: [User options and settings](/guides/users-guide/getting-started/#user-settings).
