...
The list of subscribable applications (both web applications and microservices) is displayed on the left, which consists of
...
Next column to the right, you see the **Subscribed on tenant creation**, and next column further you see the **Subscribed on platform upgrade**.
