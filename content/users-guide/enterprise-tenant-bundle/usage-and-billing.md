...
helpcontent:
  - label: usage-and-billing
    ...
    content: "The **Usage statistics** page provides statistical information on each subtenant such as the number of API requests, the number of devices connected to the subtenant, the amount of data stored in the account, or the number applications subscribed to the tenant.
    ...
    See also *Enterprise tenant > Usage statistics and billing* in the *User guide*."
