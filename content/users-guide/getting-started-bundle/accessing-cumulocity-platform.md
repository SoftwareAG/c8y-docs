...
* The [Apama Streaming Analytics application](/apama/overview-analytics/#apama-epl-apps) and [Apama Analytics Builder](/apama/overview-analytics/#analytics-builder) do not support mobile/ touch devices.
