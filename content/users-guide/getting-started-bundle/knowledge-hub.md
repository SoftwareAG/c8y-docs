...
>**Info:** The Knowledge Hub is only available for users who accepted the Gainsight functional cookies. Users can opt out from the Knowledge Hub using the **Product experience** toggle in the **User settings** menu. For details, see [Getting started > User setting](/users-guide/getting-started/#user-settings).
