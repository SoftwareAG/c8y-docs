...
<td style="text-align:left">Provides access to the <a href="/users-guide/getting-started#user-settings-change" class="no-ajaxy">user settings</a>, see below. </td>
</tr>
<tr>
...
### <a name="user-settings-change"></a>To change user settings
