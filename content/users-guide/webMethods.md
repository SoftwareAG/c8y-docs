...
webMethods.io Integration is {{< company-sag >}}'s cloud based integration solution. It enables you to automate tasks by connecting cloud web apps and services (such as Marketo, Salesforce, Evernote, and Gmail) without writing any code.
...
{{< c8y-admon-info >}}
If your tenant has been created outside of {{< sag-cloud >}} you will not benefit from the user experience described below. You can still use webMethods.io to integrate {{< product-c8y-iot >}} with other web apps, but you cannot use the web app switcher and single sign-on login.
{{< /c8y-admon-info >}}
...
2. In the web app switcher, select **webMethods.io Integration**.

![webMethods.io App Switcher Integration](/images/users-guide/webMethods.io/wmio-appswitcher-integration.png)

{{< c8y-admon-info >}}
If the icon is unavailable you might not be subscribed to **webMethods.io Integration**. Subscribe to it by opening the web app switcher and clicking **MyCloud**. This will take you to the **{{< sag-cloud >}}** portal where you can subscribe for a free trial.
