...
Most of the content of the manifest file corresponds to the application API properties, described in the [REST reference](https://{{< domain-c8y >}}/api/{{< c8y-current-version >}}/api/#tag/Application-API). Examples of manifest files can be found in [the GitHub repository](https://github.com/SoftwareAG/cumulocity-ui-plugin-examples).
