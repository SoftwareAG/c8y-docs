...
From day one the UI has always had a modular architecture. The units of functionality are grouped in â€œpluginsâ€ that can be composed to build applications. In practice plugins are simply modules.
