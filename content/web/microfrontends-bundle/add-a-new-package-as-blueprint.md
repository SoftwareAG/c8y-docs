...
Select the version for which you want to create a sample application, for example, "1015.33.0 (next)":
...
Select an application template as the basis for your plugin, for example, "package-blueprint":
...
### 2. Differences in approach to creating custom applications
