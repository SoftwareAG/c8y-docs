...
{{< c8y-admon-info >}}
The first two numbers of the version are combined (eg. 10.6 becomes 1006) as npm only supports semver version numbers. You can also remove the `-a` flag, in this case the version tagged with `latest` will be used.
{{< /c8y-admon-info >}}
