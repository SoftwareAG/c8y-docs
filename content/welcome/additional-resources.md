...
The **Installation and Operations guides** for the {{< product-c8y-iot >}} platform are not publicly available. They are provided on the [{{< company-sag >}} {{< sag-documentation >}}]({{< link-sag-documentation >}}) website. Search for "{{< product-c8y-iot >}} Platform" as product. To view the Installation and Operations guides you must click the PDF icon for the version of your choice.
