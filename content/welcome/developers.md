...
<td align="left">How to integrate IoT data sources with the {{< product-c8y-iot >}} platform. The <em>Device SDK guide</em> provides detailed information on device integration using MQTT, REST and C++.</td>
</tr>
