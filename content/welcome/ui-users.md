...
Read about the concepts behind {{< product-c8y-iot >}} and get detailed advice on using our standard web apps (Cockpit, Device Management and Administration) as well as various optional services.
...
<td align="left">The <i>User guide</i> is the main reference for working with our platform via the UI and provides in-depth explanation on all aspects of the {{< product-c8y-iot >}} default web apps (Administration, Cockpit and Device Management).</td>
</tr>
