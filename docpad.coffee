	...
	templateData:
      ...
      # Scripts
		...
		sections: [
			...
			{ title: 'Cumulocity Edge', folder: 'guides/edge', slug: 'cumulocity-edge', icon : 'fa fa-book', description: 'How to install, run and operate Cumulocity Edge, the local version of Cumulocity IoT.'},
