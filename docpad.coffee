	...
	templateData:
      ...
      # Scripts
		...
		sections: [
			...
			{ title: 'Predictive Analytics guide', folder: 'guides/predictive-analytics' , slug: 'predictive-analytics', icon : 'c8y-icon c8y-icon-data-explorer', description: 'Detailed information on the predictive analytics capabilities in the Cumulocity IoT platform.'}			
			]
