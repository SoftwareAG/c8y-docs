...
docpadConfig = {
	...
	templateData: {
		...
		sections:  [
			...
			{ title: ‘Konzepte’, folder: 'guides/konzepte’, slug: ‘Konzepte’, icon: 'glyphicon-asterisk', description: ‘Erklärung des technischen Konzepts und der Architektur hinter der Cumulocity IoT Plattform für alle Interessierten’ },
