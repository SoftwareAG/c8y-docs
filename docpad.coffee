...
docpadConfig = {
	...
	templateData: {
		...
		sections:  [
			...
			{ title: 'CEL Analytics Guide', folder: 'guides/event-language' , slug: 'event-language', icon : 'glyphicon-book', description: 'TBD'},
			{ title: 'Apama Analytics Guide', folder: 'guides/apama' , slug: 'apama', icon : 'glyphicon-book', description: 'TBD'},
