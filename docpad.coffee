	...
	templateData:
      ...
      # Scripts
		...
		sections: [
			...
			{ title: 'Microservice SDK guide', folder: 'guides/microservice-sdk' , slug: 'microservice-sdk', icon : 'fa fa-book', description: 'How to develop and deploy microservices on top of Cumulocity'},
