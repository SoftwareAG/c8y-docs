...
![img](./img/register.png "Cumulocity Registration Page.")
...
![img](./img/integrate.png "Device integration flowchart.")
...
![img](./img/mo.png "Created device in *Cumulocity* after integrate process.")
...
![img](./img/restart.png "Execute a restart operation in *Cumulocity*.")
