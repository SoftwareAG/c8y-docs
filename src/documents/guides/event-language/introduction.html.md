...
The Cumulocity Event Language allows you to add your own logic to Cumulocity. It allows to create, update and delete your data in real-time.
In the following sections we describe the basics for understanding how the Cumulocity Event Language works and how you can create your own real-time statements.
