...
Changes to alarms will generate a new audit record. The audit record will include the username and application that triggered the update, if applicable. To get the audits for alarm, use the following request: GET /audit/auditRecords?source=<alarmId>
