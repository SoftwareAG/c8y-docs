...
To test your application, use the command "c8y server" with the complete url of your tenant as para
...
```json
{
    ...
    "replaceImports": { "core/c8yBranding": "myapplication/myBranding" },
	"applications": [
		{
