...
>**Important**: Applications deployed using this mechanism use HTTP long polling to get real-time data and this has the potential to lose incoming messages from Cumulocity when the system is heavily loaded.
