...
>**Info**: Please also applications deployed using this mechanism uses HTTP long polling to get realtime data  and this has the potential to lose incoming messages from Cumulocity when the system is heavily loaded.
