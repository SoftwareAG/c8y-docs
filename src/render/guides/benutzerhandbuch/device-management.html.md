...
<img src="/guides/images/benutzerhandbuch/registrierung.png" alt="Geräteregistrierung" style="max-width: 100%">
...
<img src="/guides/images/benutzerhandbuch/autoregisterde.png" alt="Bulk registration" style="max-width: 60%">
...
[Bulk device credentials](/guides/images/reference/device-credentials/#creds-upload).
...
<img src="/guides/images/benutzerhandbuch/devicelistde.png" alt="Geräteliste" style="max-width: 100%">
...
<img src="/guides/images/benutzerhandbuch/suche.png" alt="Volltextsuche" style="max-width: 100%">
...
<img src="/guides/images/benutzerhandbuch/gruppe2ger.png" alt="Gruppe hinzufügen" style="max-width: 60%">
...
<img src="/guides/images/benutzerhandbuch/subassetaddde.png" alt="Geräte zuordnen" style="max-width: 60%">


Um eine Untergruppe zu erstellen, klicken Sie einfach auf "Gruppe hinzufügen", wenn Sie eine Gruppe ansehen.

Um eine Gruppe zu bearbeiten, klicken Sie auf den Namen der Gruppe und auf "Editieren". Auf diese Weise können Sie den Namen der Gruppe bearbeiten und Benutzerberechtigungen für die Gruppe zuweisen. Weitere Informationen zu Berechtigungen finden Sie unter [Administration](/guides/images/benutzerhandbuch/administration-deutsch).
...
<img src="/guides/images/benutzerhandbuch/smartfiltersde.png" alt="Dynamische Gruppen" style="max-width: 60%">
...
<img src="/guides/images/benutzerhandbuch/smartgroup1de.png" alt="Dynamische Gruppe erstellen" style="max-width: 100%">
...
<img src="/guides/images/benutzerhandbuch/smartgroupdelete1de.png" alt="Dynamische Gruppe entfernen" style="max-width: 100%">
...
<img src="/guides/images/benutzerhandbuch/devicedetails-de.png" alt="Gerätedetails" style="max-width: 100%">
...
![Measurements](/guides/images/benutzerhandbuch/measurements-de.png)
...
Wenn Sie auf die Schaltfläche "Echtzeit" klicken, werden Echtzeit-Benutzeroberflächen-Updates der Graphen ermöglicht, sobald neue Daten von den angeschlossenen Geräten in das System fließen. Sie können die grafischen Anzeige- und Achsengrenzen beeinflussen, indem Sie so genannte "KPIs" einrichten. Mehr hierzu unter [Administration](/guides/images/benutzerhandbuch/administration-deutsch#kpis).
...
![Operations](/guides/images/benutzerhandbuch/operations-de.png)
...
<img src="/guides/images/benutzerhandbuch/textconfig-de.png" alt="Device details" style="max-width: 100%">
...
<center><img src="/guides/images/benutzerhandbuch/configrepscreenshot-de.png" alt="Konfigurationsablage" style="max-width: 100%"></center>
...
![Configuration Snapshot](/guides/images/benutzerhandbuch/configsnapde.png)
...
<img src="/guides/images/benutzerhandbuch/retrievesnap-de.png" alt="Konfigurationssnapshot abrufen" style="max-width: 60%">
...
<img src="/guides/images/benutzerhandbuch/addsnap-de.png" alt="Konfigurationssnapshot anwenden" style="max-width: 60%">
...
![Configuration Snapshot Repository](/guides/images/benutzerhandbuch/configsnaprepo-de.png)
...
![Software](/guides/images/benutzerhandbuch/software-de.png)
...
![Geräte-Shell](/guides/images/benutzerhandbuch/shell-de.png)
...
<img src="/guides/images/benutzerhandbuch/shelltemplates-de.png" alt="Shell-Kommandos" style="max-width: 60%">

### <a name="permissions"></a>Berechtigungen

Die Berechtigung, bestimmte Geräte anzuzeigen, zu bearbeiten oder zu steuern, kann auf Benutzer und Benutzergruppen beschränkt werden. Weitere Informationen zum Verwalten von Berechtigungen finden Sie unter [Administration](/guides/images/benutzerhandbuch/administration-deutsch). Verwenden Sie den Anwendungswechsler, um zur Administrationsanwendung zu wechseln.
...
![Tracking](/guides/images/benutzerhandbuch/tracking-de.png)
...
![Request log](/guides/images/benutzerhandbuch/requestlog-de.png)
...
<center><img src="/guides/images/users-guide/verbcontr1.png" alt="Device details" style="max-width: 60%"></center>
...
![Service monitoring](/guides/images/benutzerhandbuch/servicemonitoring-de.png)
...
Es kann Ausnahmen von dieser Regel geben. Wenn Ihre Verkaufsautomaten ausschließlich auf bargeldlose Zahlung angewiesen sind und die Verbindung zum Netzwerk verlieren, bedeutet das, dass die Automaten außer Betrieb sind und aufhören zu verkaufen. In diesem Fall müssen Nichtverfügbarkeitsalarme in der [Administrations-Anwendung](/guides/images/benutzerhandbuch/administration-deutsch#reprio-alarms) auf "kritische" Priorität statt "wichtige"-Priorität gesetzt werden.
...
* **Typ**: Die Art des Alarms. Dieser Text dient zum Duplizieren von Alarmen und zum Konfigurieren der Priorität von Alarmen in der [Administrations-Anwendung](/guides/images/benutzerhandbuch/administration-deutsch#reprio-alarms).
...
![Alarm display](/guides/images/benutzerhandbuch/alarme-de.png)
...
![Sammelkommando ausführen](/guides/images/benutzerhandbuch/executebulkoperations-de.png)

<img src="/guides/images/benutzerhandbuch/executebulkoperations2-de.png" alt="Sammelkommando ausführen Schritt 2" style="max-width: 60%">
...
![Sammelkommando Status](/guides/images/benutzerhandbuch/bulkoperationsde.png)
...
1. Laden Sie Firmware- und Software-Dateien mit der [Administrations-Anwendung](/guides/images/benutzerhandbuch/administration-deutsch#files) hoch. (Dieser Schritt ist optional und nicht zwingend erforderlich, da der Hersteller die Firmware auch online anbieten kann.)
...
3. Installieren Sie die Firmware oder Software auf einem bestimmten Gerät. Zuerst navigieren Sie zu "Alle Geräte". Wählen Sie das gewünschte Gerät und gehen Sie dann zum "Software"-Tab. Wählen Sie die zu installierende Firmware oder Software aus und klicken Sie auf "Installieren".  (Mehr hierzu unter [Software](/guides/images/benutzerhandbuch/device-management-deutsch#software).)

> Sie müssen die Administrations-Anwendung aufrufen, um andere Binärdateien in Cumulocity zu speichern. Siehe auch [Administration](/guides/images/benutzerhandbuch/administration-deutsch#files).
...
<img src="/guides/images/benutzerhandbuch/autoregisterde.png" alt="Sammelregistrierung" style="max-width: 60%">
...
![Neuer Simulator](/guides/images/benutzerhandbuch/newsimde.png)
...
<img src="/guides/images/benutzerhandbuch/addsimde.png" alt="Add Simulator" style="max-width: 60%">
...
<img src="/guides/images/benutzerhandbuch/addtempsimde.png" alt="Add Temperature Preset" style="max-width: 60%">

<img src="/guides/images/benutzerhandbuch/addpossimde.png" alt="Add Position Preset" style="max-width: 60%">
...
![Simulator-Optionen](/guides/images/benutzerhandbuch/editcloneremsimde.png)
...
![Simulator-Anweisungen](/guides/images/benutzerhandbuch/addinstructionsde.png)

Die folgende Übersicht erscheint:

![Simulator-Anweisungen Schritt 2](/guides/images/benutzerhandbuch/addinstructions2de.png)
...
![Simulator-Anweisungen Schritt 3](/guides/images/benutzerhandbuch/addinstructions3de.png)
...
![Simulator-Anweisungen Schritt 4](/guides/images/benutzerhandbuch/addinstructions4de.png)
...
![Kommandos aus](/guides/images/benutzerhandbuch/supop1de.png)

![Kommandos an](/guides/images/benutzerhandbuch/supop2de.png)
...
![VNC](/guides/images/benutzerhandbuch/VNC1a-DE.png)
...
![VNC2](/guides/images/benutzerhandbuch/VNC2-DE.png)
...
![VNC1b](/guides/images/benutzerhandbuch/VNC1b-DE.png)
...
![Router](/guides/images/benutzerhandbuch/routerdevice-de.png)
...
![Endpunkte](/guides/images/benutzerhandbuch/endpoints-de.png)
...
Um einen Endpunkt zu konfigurieren, benötigen Sie die folgenden Berechtigungen: Sowohl "Remote access" (Fernzugriff) als auch "Kommandos" müssen auf “Admin” gesetzt sein. Um Daten zu lesen, reicht eine "Lese"-Berechtigung. Für weitere Informationen über die Gewährung von Berechtigungen siehe [Berechtigungen verwalten](/guides/images/benutzerhandbuch/administration-deutsch/#permissions).
...
<img src="/guides/images/benutzerhandbuch/remoteaccess-de.png" alt="Remote-Access-Endpunkt" style="max-width: 60%">
...
![Endpunkte verbinden](/guides/images/benutzerhandbuch/connectendp-de.png)
...
![Endpunkte bearbeiten](/guides/images/benutzerhandbuch/editendpoint-de.png)
