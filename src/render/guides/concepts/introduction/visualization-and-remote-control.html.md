...
Through the [Sensor Library](/guides/images/reference/sensor-library), common sensor and control types are rendered  correctly regardless of the device that produces the sensor data.
