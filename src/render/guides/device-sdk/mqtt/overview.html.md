...
* [Hello MQTT C](/guides/device-sdk/mqtt#hello-mqtt-c) provides an introduction on how to use the MQTT client in C with Cumulocity using pre-defined messages (called "static templates").
* [Hello MQTT C#](/guides/device-sdk/mqtt#hello-mqtt-cs-0) provides an introduction on how to use the C# MQTT client with Cumulocity using pre-defined messages (called "static templates").
