...
Cumulocity Edge uses the same software as Cumulocity IoT Core. 
...
|AREA|CUMULOCITY EDGE|CUMULOCITY IOT CORE
|:---|:---|:--
...
>**Info**: In addition to Cumulocity Edge, we provide a light-weight approach to implement edge functionality: the Cumulocity Agent and Device SDK. These can be installed on less powerful devices like embedded devices. 
