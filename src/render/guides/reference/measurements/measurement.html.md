...
If a fragment contains a series, i.e. an object with a property named value, then it is treated as a series and anything inside that fragment that is not a series is not preserved and removed from the fragment.

> "c8y_TemperatureMeasurement": { 
> "T": { 
> "value": 25
> }, 
> "notWorkingInsideFragment": 123, 
> "alsoNotWorkingInsideFragment": { 
> "test": 123 
> } 

Note that for correct visualization of measurement series on UI graphs, property names used for fragment and series name should not contain whitespaces and special characters like ```[],*.```.
