...
|isolation|Enum|Values: MULTI&#95;TENANT, PER&#95;TENANT<br/>Default: MULTI&#95;TENANT<br/><br/>Deployment isolation. When PER&#95;TENANT separate instance for each tenant otherwise single instance for all subscribed tenants. Should be overridable on subscription and should affect billing.|No
