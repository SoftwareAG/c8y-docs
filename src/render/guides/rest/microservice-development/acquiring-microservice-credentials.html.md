...
The following section is a wrap up for user management as described under "Cumulocity microservices" in [Developing applications](/guides/concepts/applications) in the Concepts guide.
