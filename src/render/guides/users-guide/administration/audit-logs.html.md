...
|Operation|Type of operation, e.g. "Alarm created", Smart rule deleted". Below it, the user processing it is displayed.
...
>**Info**: The audit log list is not automatically refreshed after a real-time update for operations. Click **Reload** at the right of the top menu bar to update the list to the latest operations.
