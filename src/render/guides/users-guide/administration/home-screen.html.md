...
<img src="/guides/images/users-guide/Administration/admin-home.png" alt="Home screen">
...
* Storage: The total amount of data stored in your account. This amount can be changed by [retention policies](/guides/users-guide/administration/#retention-rules) and by the amount and size of [stored files](/guides/users-guide/administration#files).
