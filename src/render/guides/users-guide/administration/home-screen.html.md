...
* Storage: The total amount of data stored in your account. This amount can be changed by [retention policies](/guides/users-guide/administration/#data-retention#retention-rules) and by the amount and size of [stored files](/guides/users-guide/administration/retention-rules#files).
