...
To open CSV files in Microsoft Excel, you need to import the data. To do so, follow these steps:

1. In Microsoft Excel, switch to the **Data** tab.
1. In the **Data** tab, select **From Text** in the top menu bar.
1. Select the CSV file you want to import by browsing for it (in this case the template file that you have downloaded from the Cumulocity platform).
1. In Step 1 of the **Text Import Wizard**, leave the default settings and click **Next**.
1. In Step 2 of the **Text Import Wizard**, select "Semicolon" as delimiter and click **Finish**.
