...
After creation, the bootstrap parameters can be viewed and changed in the "LWM2M bootstrap parameters" tab in the "Device details" page. For further information, refer to [LWM2M bootstrap parameters tab](/guides/users-guide/device-management#lwm2m-bootstrap).
