...
On top of this, Cumulocity provides broad functionality to add your own applications to be used in your Cumulocity account, see [Administration > Managing applications](/guides/users-guide/administration#managing-applications) for details.
