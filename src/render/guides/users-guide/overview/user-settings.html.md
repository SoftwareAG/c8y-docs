...
Click **Change password** to change your current password. For details refer to [Changing your password](guides/users-guide/overview/accessing-cumulocity-platform#change-password).
